...
| name          |                            |              |              |
+:==============+:===========================+:=============+:=============+
| panic_12m_s3  | Panic disorder during last | Categorical  | 0 = no       |
|               | 12 months (c2011_w4)       |              |              |
|               |                            |              | 1 = yes      |
+---------------+----------------------------+--------------+--------------+
| panic_3y_s3   | Three years panic disorder | Categorical  | 0 = no       |
|               | (c2011_w4)                 |              |              |
|               |                            |              | 1 = yes      |
+---------------+----------------------------+--------------+--------------+
...
To generate the three years variable (panic disorder occurred since the last
...
***#"Three years panic disorder diagnostic variable"
gen     panic_3y_s3 = .
...
label variable panic_3y_s3 "Three years panic disorder (c2011_w4)"
