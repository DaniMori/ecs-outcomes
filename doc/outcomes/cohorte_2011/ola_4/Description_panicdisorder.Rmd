...
+:===================+:================================+:============+:========+
| panic_12m_s3       | Panic disorder during last 12   | Categorical | 0 = no  |
|                    | months (c2011_w4)               |             |         |
|                    |                                 |             | 1 = yes |
+--------------------+---------------------------------+-------------+---------+
| panic_lifetime_s3  | Lifetime panic disorder         | Categorical | 0 = no  |
|                    | (c2011_w4)                      |             |         |
|                    |                                 |             | 1 = yes |
+--------------------+---------------------------------+-------------+---------+
...
To generate the lifetime variable (panic_lifetime_s3), the following criteria
related to the DSM were considered and all of them must be present:
...
recode q4501_anxlife_s3 q4502_unclife_s3 (888=.) (999=.)
gen     d_crit1 = .
...
recode q4503_beat_s3 q4504_air_s3 q4505_nausea_s3 q4506_dizziness_s3 q4507_sweat_s3 q4508_trembling_s3 q4509_mouth_s3 q4510_choke_s3 q4511_chest_s3 q4512_control_s3 q4513_deper_s3 q4514_disreal_s3 q4515_cons_s3 q4516_dying_s3 q4517_suffoc_s3 q4518_tingling_s3 (888=.) (999=.) (2=0) 
...
gen     panic_lifetime_s3 = .
replace panic_lifetime_s3 = 0 if  d_crit1==0 | d_crit2==0 | d_crit3==0 | d_crit4==0
replace panic_lifetime_s3 = 1 if d_crit1==1 & d_crit2==1 & d_crit3==1 & d_crit4==1
label values   panic_lifetime_s3 yesno
label variable panic_lifetime_s3 "Lifetime panic disorder (c2011_w4)"

***#"12 months panic disorder diagnostic variable"
gen panic_12m_s3 = .
replace panic_12m_s3 = 0 if (q4524_crisis12_s3!=1 & q4524_crisis12_s3!=.)
replace panic_12m_s3 = 1 if q4524_crisis12_s3==1
...
keep ID_ECS q0007a_result proxy panic_12m_s3 panic_lifetime_s3

codebook panic_12m_s3 panic_lifetime_s3
```
