...
## Migraine
Migraine is a primary headache disorder and it is caused by the activation of a mechanism deep in the brain that leads to release of pain-producing inflammatory substances around the nerves and blood vessels of the head. A large number of people with headache disorders are not diagnosed and treated: worldwide only 40% of those with migraine are professionally diagnosed. In the Global Burden of Disease Study of 2016, migraine affected more than one billion people globally, caused 45 million years lost due to disability (YLDs) and was the second most disabling condition worldwide. Among young adults (under 50 years of age), it was the most disabling.

## Chronic Back Pain
Chronic back pain is defined as pain that continues for 12 weeks or longer. It has been found to be the leading cause of disability when analysed globally and has remained one of the top 2 contributors of global disability causes for over two decades.
Chronic low back pain: About 20 percent of people affected by acute low back pain develop chronic low back pain with persistent symptoms at one year.
Chronic cervical, neck or upper-back pain: Although most acute episodes resolve spontaneously, more than a third of affected people still have low grade symptoms or recurrences more than one year later, with genetics and psychosocial factors being risk factors for persistence.

## Dementia
Dementia is a syndrome in which there is deterioration in cognitive function (i.e. the ability to process thought) beyond what might be expected from normal ageing. It affects memory, thinking, orientation, comprehension, calculation, learning capacity, language, and judgement. The impairment in cognitive function is commonly accompanied, and occasionally preceded, by changes in mood, emotional control, behaviour, or motivation. Dementia results from a variety of diseases and injuries that primarily or secondarily affect the brain, such as Alzheimer's disease or stroke.
...
## Hypertension
Those participants with systolic blood pressure ≥140 mmHg (q2501_syst_s3, q2502_syst_s3, measured twice) and/or diastolic blood pressure ≥90 mmHg (q2501_diast_s3, q2502_diast_s3, measured twice) were considered to have hypertension (blood pressure measurement). Hypertension diagonisis was also assess if participan answer "yes" to the self-reported question about the condition (q4060_high_bp_s3) but not "997" (they affirmed they had never had the disease). 

## Cataracts
A diagnosis of cataracts was made if the participant says he has the condition (q4062_catar_s3) or if he suffer from those two symptoms: (1) blurred or hazy vision (q4064_vision_s3) and (2) visual problems with light (q4065_light_s3) or if he has undergone surgery (q4063_surgery_s3).We also included a treatment code (cataracts_self=2) in those individuals who, apart from having reported a 
cataract diagnosis, have had surgery for cataracts in the previous 12 months.

## Oral Health
Oral problems were endorsed if the participant answered "yes" to the self-reported question about any oral conditions (q4067_symptoms_s3) or has been pharmacology treated for oral problem (q4068b_treated_s3). We also consider the age at which the participants lost all their teeth (q4066_teeth_s3). Those participants who answered “yes” to q4066_teeth_s3, 
...
## Kidney Disease
A diagnosis of kidney disease was endorsed if the participant self-reported having a kidney diases (q4085_kidney_s3) or take treatment for kidney disease (q4086_s3).

## Digestive Disease
A diagnosis of digestive disease was endorsed if the participant self-reported having a kidney diases (q4087_s3) or take treatment for kidney disease (q4088_s3).

## Cancer
A diagnosis of cancer disease was endorsed 
if the participant answered "yes" to self-reported question about cancer (q4089_s3). 

## Liver Disease
A diagnosis of liver disease was endorsed if the participant self-reported having a kidney diases (q4091_s3) or take treatment for kidney disease (q4092_s3).

## Osteoporosis
A diagnosis of osteoporosis was endorsed if the participant self-reported having a kidney diases (q4093_s3) or take treatment for kidney disease (q4094_s3).

## Anaemia
A diagnosis of anaemia was endorsed if the participant self-reported having a kidney diases (q4095_s3) or take treatment for kidney disease (q4096_s3).


## Thyroid
A diagnosis of hyperthyroid or hypothyroid was endorsed if the participant self-reported having a kidney diases (q4097_s3) or take treatment for kidney disease (q4098_s3).

## Glaucoma

A diagnosis of glaucoma was endorsed if the participant self-reported having a kidney diases (q4099_s3) or take treatment for kidney disease (q4100_s3).

## Heart Disease
A diagnosis of heart disease was endorsed if the participant self-reported having a kidney diases (q4101_s3) or take treatment for kidney disease (q4102_s3).

## Migraine
Original variables include self-reported diagnose (q4119) and treatment (q4119c). A diagnosis of migraine was endorsed if the participant answered "yes" to q4119. We also included a treatment code (migr_self=2) in those individuals who reported migraine and received treatment for it in the previous 12 months.

## Chronic Back pain
Diagnosis of chronic low back or cervical pain were made if the participant self-reported chronic back pain (q4112) or was treat for it (q4113c). Those participants reported suffering from back pain by answering "yes" to q4112 were defined as having had lombalgy. We also included a treatment code (low_self =2 or cerv_self =2) in those individuals who reported a diagnosis and had received treatment for it in the previous 12 months.

## Dementia
Original variables include question about previous diagnose of dementia (q4105) and treatment (q4106c). A diagnosis of dementia was endorsed if the participant answered "yes" to q4105. We also included a treatment code (dem_self=2) in those individuals who reported dementia and received treatment for it in the previous 12 months.
...
label variable osteoart_s3 "Osteoarthritis self-reported test"
...
recode q4022_diabetes_s3 (888=.), gen (diab_self)
replace diab_self=2 if q4022a_s3==997
label values diab_self labels1
label variable diab_self "Diabetes self-reported"

recode q4023b_treated (888=.) (2=0), gen (diab_2)
label values diab_2 labels1
label variable diab_2 "Treatment for diabetes"

gen diab_self=.
replace diab_self=0 if diabetes==0
replace diab_self=1 if diabetes==1 
replace diab_self=2 if diabetes==1 & diab_2==1
label values diab_self labels2
label variable diab_self "Diabetes self-reported and treatment"
...
* KIDNEY.
recode q4085_s3 (888=.), gen (kidney)
replace kidney=2 if q4085a_s3==997
label values kidney labels1
label variable kidney "Kidney problems self-reported"

recode q4086c (888=.) (2=0), gen (kidney_2)
label values kidney_2 labels1
label variable kidney_2 "Treatment for kidney disease"

gen kidney_self=.
replace kidney_self=0 if kidney ==0
replace kidney_self=1 if kidney==1 
replace kidney_self=2 if kidney==1 | kidney_2==1
label values kidney_self labels2
label variable kidney_self "Kidney disease self-reported or treatment"
*NOTE: self-reported AND treatment or self-reported OR treatment or just take 
*into acount "self-reported" and not treatment?


* DIGESTIVE.
recode q4087_s3 (888=.), gen (digestive)
replace digestive=2 if q4087a_s3==997
label values digestive labels1
label variable digestive "Digestive problems self-reported"

recode q4088c (888=.) (2=0), gen (digestive_2)
label values digestive_2 labels1
label variable digestive_2 "Treatment for digestive disease"

gen digestive_self=.
replace digestive_self=0 if digestive==0
replace digestive_self=1 if digestive==1 
replace digestive_self=2 if digestive==1 & digestive_2==1
label values digestive_self labels2
label variable digestive_self "Digestive problems self-reported and treatment"
...
* LIVER.
recode q4091_s3 (888=.), gen (liver)
replace liver=2 if q4091a_s3==997
label values liver labels1
label variable liver "Liver self-reported"

recode q4092c (888=.) (2=0), gen (liver_2)
label values liver_2 labels1
label variable liver_2 "Treatment for liver"

gen liver_self=.
replace liver_self=0 if liver==0
replace liver_self=1 if liver==1 
replace liver_self=2 if liver==1 & liver_2==1
label values liver_self labels2
label variable liver_self "Liver disease self-reported and treatment"
*NOTE: self-reported AND treatment or self-reported OR treatment or just take 
*into acount "self-reported" and not treatment?
...
* OSTEOPOROSIS.
recode q4093_s3 (888=.), gen (osteo)
replace osteo=2 if q4093a_s3==997
label values osteo labels1
label variable osteo "Osteoporosis self-reported"

recode q4094c (888=.) (2=0), gen (osteop_2)
label values osteop_2 labels1
label variable osteop_2 "Treatment for osteoporosis"

gen osteop_self=.
replace osteop_self=0 if osteop==0
replace osteop_self=1 if osteop==1 
replace osteop_self=2 if osteop==1 & osteop_2==1
label values osteop_self labels2
label variable osteop_self "Osteoporosis self-reported and treatment"
*NOTE: self-reported AND treatment or self-reported OR treatment or just take 
*into acount "self-reported" and not treatment?


* ANAEMIA.
recode q4095_s3 (888=.), gen (anaemia_s3)
replace anaemia_s3=2 if q4095a_s3==997
label values anaemia_s3 labels1
label variable anaemia_s3 "Anaemia self-reported"

recode q4096c (888=.) (2=0), gen (anaemia_2)
label values anaemia_2 labels1
label variable anaemia_2 "Treatment for anaemia"

gen anaemia_self=.
replace anaemia_self=0 if anaemia==0
replace anaemia_self=1 if anaemia==1 
replace anaemia_self=2 if anaemia==1 & anaemia_2==1
label values anaemia_self labels2
label variable anaemia_self "Anaemia self-reported and treatment"
*NOTE: self-reported AND treatment or self-reported OR treatment or just take 
*into acount "self-reported" and not treatment?

* THYROID.
recode q4097_s3 (888=.), gen (thyroid_s3)
replace thyroid_s3=2 if q4097a_s3==997
label values thyroid_s3 labels1
label variable thyroid_s3 "Thyroid disease self-reported"

recode q4098c (888=.) (2=0), gen (thyroid_2)
label values thyroid_2 labels1
label variable thyroid_2 "Treatment for thyroid"

gen thyroid_self=.
replace thyroid_self=0 if thyroid==0
replace thyroid_self=1 if thyroid==1 
replace thyroid_self=2 if thyroid==1 & thyroid_2==1
label values thyroid_self labels2
label variable thyroid_self "Thyroid self-reported and treatment"
*NOTE: self-reported AND treatment or self-reported OR treatment or just take 
*into acount "self-reported" and not treatment?


* GLAUCOMA.
recode q4099_s3 (888=.), gen (glaucoma_s3)
replace glaucoma_s3=2 if q4099a_s3==997
label values glaucoma_s3 labels1
label variable glaucoma_s3 "Glaucoma self-reported"

recode q4100c (888=.) (2=0), gen (glaucoma_2)
label values glaucoma_2 labels1
label variable glaucoma_2 "Treatment for glaucoma"

gen glaucoma_self=.
replace glaucoma_self=0 if glaucoma==0
replace glaucoma_self=1 if glaucoma==1 
replace glaucoma_self=2 if glaucoma==1 & glaucoma_2==1
label values glaucoma_self labels2
label variable glaucoma_self "Glaucoma self-reported and treatment"
*NOTE: self-reported AND treatment or self-reported OR treatment or just take 
*into acount "self-reported" and not treatment?
...
* MIGRAINE.
recode q4119 (888=.) (999=.) (2=0), gen (migraine)
label values migraine labels1
label variable migraine "Migraine self-reported (c2011_w4)"

recode q4119c (888=.) (2=0), gen (migr_2)
label values migr_2 labels1
label variable migr_2 "Treatment for migraine"

gen migr_self=.
replace migr_self=0 if migraine==0
replace migr_self=1 if migraine==1 
replace migr_self=2 if migraine==1 & migr_2==1
label values migr_self labels2
label variable migr_self "Migraine self-reported and treatment"

*CHRONIC BACK PAIN
**Lower back pain
recode q4112 (888=.) (999=.) (2=0), gen (lowback)
recode q4112m (888=.) (999=.) (2=0), gen (low_1)
recode q4113c (888=.) (2=0), gen (low_2)
label values (lowback low_1 low_2) labels1
label variable lowback "Lower back pain self-reported (c2011_w4)"
label variable low_1 "Self-reported diagnosis lower back pain"
label variable low_2 "Treatment for lower back pain"
replace lowback=1 if low_1==1
gen low_self=.
replace low_self=0 if low_1==0 | lowback==0
replace low_self=1 if low_1==1 
replace low_self=2 if lowback==1 & low_2==1
label values low_self labels2
label variable low_self "Lower back pain self-reported and treatment"

**Cervical pain
recode q4120pre (888=.) (999=.) (2=0), gen (cervical)
recode q4120 (888=.) (999=.) (2=0), gen (cerv_1)
recode q4120c (888=.) (2=0), gen (cerv_2)
label values (cervical cerv_1 cerv_2) labels1
label variable cervical "Cervical pain self-reported (c2011_w4)"
label variable cerv_1 "Self-reported diagnosis cervical pain"
label variable cerv_2 "Treatment for cervical pain"
replace cervical=1 if cerv_1==1

gen cerv_self=.
replace cerv_self=0 if cerv_1==0 | cervical==0
replace cerv_self=1 if cerv_1==1 
replace cerv_self=2 if cervical==1 & cerv_2==1
label values cerv_self labels2
label variable cerv_self "Cervical pain self-reported and treatment"

* DEMENTIA.
recode q4105 (888=.) (999=.) (2=0), gen (dementia)
recode q4106c (888=.) (2=0), gen (dem_2)
label values (dementia dem_2) labels1
 label variable dementia "Dementia self-reported (c2011_w4)"
label variable dem_2 "Treatment for dementia"

gen dem_self=.
replace dem_self=0 if dementia==0
replace dem_self=1 if dementia==1 
replace dem_self=2 if dementia==1 & dem_2==1
label values dem_self labels2
label variable dem_self "Dementia self-reported and treatment"
