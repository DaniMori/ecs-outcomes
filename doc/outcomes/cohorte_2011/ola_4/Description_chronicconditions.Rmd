...
Chronic kidney disease includes complications like high blood pressure, anemia,
...
* Chronic low back pain: About 20 percent of people affected by acute
low back pain develop chronic low back pain with persistent symptoms at one
year. 

* Chronic cervical, neck or upper-back pain: Although most acute episodes
...
(`q4016_symptoms_s3`, `q4017_symptoms_s3`, `q4018_r`, `q4019_s`, `q4020_where_6_s3`,
`q4020_where_7_s3`, `q4020_where_8_s3`, `q4020_where_11_s3`).
Diagnosis of angina was endorsed if the participant answered "yes" (1) to 
self-reported diagnosis , but not if they affirmed they had never had the 
disease (not "997" to `q4014_angina_s3`).
...
the disease). 
**NOTE**: it is possible to create the symptom algorithm in a less
conservative way. That is: if `q4035_symptoms_s3=1` and `q4036_symptoms_s3=1` or
`q4037_symptoms_s3=1` or `q4038_symptoms_s3=1` or `q4039_symptoms_s3=1`, 
`asthma_test=1`. There is, apparently, no wrong or right option.
...
having a kidney disease (`q4085_kidney_s3`). Treatment taken for kidney disease 
have also been taken into account (`q4086_s3`).

## Digestive Disease

A diagnosis of digestive disease was endorsed if the participant self-reported
having a kidney disease (`q4087_s3`). Treatment taken for digestive disease 
have also been taken into account (`q4088_s3`).
...
having a kidney disease (`q4091_s3`). Treatment taken for liver disease 
have also been taken into account (`q4092_s3`).

## Osteoporosis

A diagnosis of osteoporosis was endorsed if the participant self-reported having
a kidney disease (`q4093_s3`). Treatment taken for osteoporosis have also been 
...
self-reported having a kidney disease (`q4097_s3`). Treatment taken for tyroid 
...
having a kidney diases (`q4101_s3`). Treatment taken for heart disease 
have also been taken into acount (`q4102_s3`).
...
chronic back pain (q4112). Treatment taken for chronic low back pain 
have also been taken into acount (q4113c). 
