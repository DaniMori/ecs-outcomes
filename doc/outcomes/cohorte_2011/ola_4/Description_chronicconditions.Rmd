...
recode q4063_surgery_s3 (888=.) (2=0), gen (catar_treatment_s3)
label values catar_treatment_s3 labels1
label variable catar_treatment_s3 "Treatment for cataract"
...
replace cataracts_s3=2 if catar_treatment_s3==1
label values cataracts_s3 labels2
...
replace lowback_self_s3=0 if q4112_s3==997
