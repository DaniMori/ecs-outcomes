...
|                | (c2011_w4)            |                | 1 yes          |
+----------------+-----------------------+----------------+----------------+
| diab_s3        | diabetes self         | dummy          | 2 no           |
|                | reported (c2011_w4)   |                |                |
|                |                       |                | 1 yes          |
+----------------+-----------------------+----------------+----------------+
| lung_s3        | lung disease          | dummy          | 2 no           |
|                | algorithm test or     |                |                |
|                | self-reported         |                | 1 yes          |
|                | (c2011_w4)            |                |                |
+----------------+-----------------------+----------------+----------------+
...
|                | (c2011_w4)            |                | 1 yes          |
+----------------+-----------------------+----------------+----------------+
| hy             | hypertension          | dummy          | 2 no           |
| pertension_s3  | algorithm test or     |                |                |
|                | self reported         |                | 1 yes          |
|                | (c2011_w4)            |                |                |
+----------------+-----------------------+----------------+----------------+
...
|                | (c2011_w4)            |                | 1 yes          |
+----------------+-----------------------+----------------+----------------+
| ora            | oral problems         | dummy          | 2 no           |
| l_problems_s3  | algorithm test or     |                |                |
|                | self reported         |                | 1 yes          |
|                | (c2011_w4)            |                |                |
+----------------+-----------------------+----------------+----------------+
...
|                |                       |                | 1 yes          |
+----------------+-----------------------+----------------+----------------+
| diges_s3       | digestive self        | dummy          | 2 no           |
|                | reported (c2011_w4)   |                |                |
|                |                       |                | 1 yes          |
+----------------+-----------------------+----------------+----------------+
...
|                |                       |                | 1 yes          |
+----------------+-----------------------+----------------+----------------+
| glaucoma_s3    | glaucoma self         | dummy          | 2 no           |
|                | reported (c2011_w4)   |                |                |
|                |                       |                | 1 yes          |
+----------------+-----------------------+----------------+----------------+
...
|                |                       |                | 1 yes          |
+----------------+-----------------------+----------------+----------------+
|                | Migraine self         | dummy          | 2 no           |
|                | reported              |                |                |
|                |                       |                | 1 yes          |
+----------------+-----------------------+----------------+----------------+
|                | Chronic Back Pain     | dummy          | 2 no           |
|                | self reported         |                |                |
|                |                       |                | 1 yes          |
+----------------+-----------------------+----------------+----------------+
|                | Dementia self         | dummy          | 2 no           |
|                | reported              |                |                |
|                |                       |                | 1 yes          |
+----------------+-----------------------+----------------+----------------+
...
having a kidney diases (q4085_kidney_s3) or take treatment for kidney disease
(q4086_s3).

## Digestive Disease

A diagnosis of digestive disease was endorsed if the participant self-reported
having a kidney diases (q4087_s3) or take treatment for kidney disease
(q4088_s3).
...
having a kidney diases (q4091_s3) or take treatment for kidney disease
(q4092_s3).

## Osteoporosis

A diagnosis of osteoporosis was endorsed if the participant self-reported having
a kidney diases (q4093_s3) or take treatment for kidney disease (q4094_s3).

## Anaemia

A diagnosis of anaemia was endorsed if the participant self-reported having a
kidney diases (q4095_s3) or take treatment for kidney disease (q4096_s3).

## Thyroid

A diagnosis of hyperthyroid or hypothyroid was endorsed if the participant
self-reported having a kidney diases (q4097_s3) or take treatment for kidney
disease (q4098_s3).

## Glaucoma

A diagnosis of glaucoma was endorsed if the participant self-reported having a
kidney diases (q4099_s3) or take treatment for kidney disease (q4100_s3).

## Heart Disease

A diagnosis of heart disease was endorsed if the participant self-reported
having a kidney diases (q4101_s3) or take treatment for kidney disease
(q4102_s3).
...
Diagnosis of chronic low back or cervical pain were made if the participant
self-reported chronic back pain (q4112) or was treat for it (q4113c). Those
participants reported suffering from back pain by answering "yes" to q4112 were
defined as having had lombalgy. We also included a treatment code (low_self =2
or cerv_self =2) in those individuals who reported a diagnosis and had received
