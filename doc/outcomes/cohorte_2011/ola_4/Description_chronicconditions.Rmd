...
| name            |                    |                 |                 |
+:================+:===================+:================+:================+
| arthritis_s3    | arthritis          | dummy           | 0 No            |
|                 | algorithm test or  |                 |                 |
|                 | self-reported      |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
+-----------------+--------------------+-----------------+-----------------+
| stroke_s3       | stroke algorithm   | dummy           | 0 No            |
|                 | test or            |                 |                 |
|                 | self-reported      |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
+-----------------+--------------------+-----------------+-----------------+
| angina_s3       | angina algorithm   | dummy           | 0 No            |
|                 | test or            |                 |                 |
|                 | self-reported      |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
+-----------------+--------------------+-----------------+-----------------+
| diab_s3         | diabetes           | dummy           | 0 No            |
|                 | self-reported and  |                 |                 |
|                 | treatment          |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
|                 |                    |                 | 2 Treatment     |
+-----------------+--------------------+-----------------+-----------------+
| lung_s3         | lung disease       | dummy           | 0 No            |
|                 | algorithm test or  |                 |                 |
|                 | self-reported      |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
+-----------------+--------------------+-----------------+-----------------+
| asthma_s3       | asthma algorithm   | dummy           | 0 No            |
|                 | test or            |                 |                 |
|                 | self-reported      |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
+-----------------+--------------------+-----------------+-----------------+
| hypertension_s3 | hypertension       | dummy           | 0 No            |
|                 | algorithm test or  |                 |                 |
|                 | self-reported      |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
+-----------------+--------------------+-----------------+-----------------+
| cataracts_s3    | cataracts          | dummy           | 0 No            |
|                 | algorithm test or  |                 |                 |
|                 | self-reported      |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
+-----------------+--------------------+-----------------+-----------------+
| oral_s3         | oral problems      | dummy           | 0 No            |
|                 | algorithm test or  |                 |                 |
|                 | self-reported      |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
+-----------------+--------------------+-----------------+-----------------+
| kidney_s3       | kidney             | dummy           | 0 No            |
|                 | self-reported and  |                 |                 |
|                 | treatment          |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
|                 |                    |                 | 2 Treatment     |
+-----------------+--------------------+-----------------+-----------------+
| digestive_s3    | digestive          | dummy           | 0 No            |
|                 | self-reported and  |                 |                 |
|                 | treatment          |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
|                 |                    |                 | 2 Treatment     |
+-----------------+--------------------+-----------------+-----------------+
| cancer_s3       | cancer             | dummy           | 0 No            |
|                 | self-reported      |                 |                 |
|                 | (c2011_w4)         |                 | 1 Yes           |
+-----------------+--------------------+-----------------+-----------------+
| liver_s3        | liver              | dummy           | 0 No            |
|                 | self-reported and  |                 |                 |
|                 | treatment          |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
|                 |                    |                 | 2 Treatment     |
+-----------------+--------------------+-----------------+-----------------+
| osteop_s3       | osteoporosis       | dummy           | 0 No            |
|                 | self-reported and  |                 |                 |
|                 | treatment          |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
|                 |                    |                 | 2 Treatment     |
+-----------------+--------------------+-----------------+-----------------+
| anaemia_s3      | anaemia            | dummy           | 0 No            |
|                 | self-reported and  |                 |                 |
|                 | treatment          |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
|                 |                    |                 | 2 Treatment     |
+-----------------+--------------------+-----------------+-----------------+
| thyroid_s3      | thyroid            | dummy           | 0 No            |
|                 | self-reported and  |                 |                 |
|                 | treatment          |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
|                 |                    |                 | 2 Treatment     |
+-----------------+--------------------+-----------------+-----------------+
| glaucoma_s3     | glaucoma           | dummy           | 0 No            |
|                 | self-reported and  |                 |                 |
|                 | treatment          |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
|                 |                    |                 | 2 Treatment     |
+-----------------+--------------------+-----------------+-----------------+
| heart_s3        | heart              | dummy           | 0 No            |
|                 | self-reported      |                 |                 |
|                 | (c2011_w4)         |                 | 1 Yes           |
|                 |                    |                 |                 |
|                 |                    |                 | 2 Treatment     |
+-----------------+--------------------+-----------------+-----------------+
| migr_s3         | migraine           | dummy           | 0 No            |
|                 | self-reported and  |                 |                 |
|                 | treatment          |                 | 1 Yes           |
|                 | (c2011_w4)         |                 |                 |
|                 |                    |                 | 2 Treatment     |
...
Osteoarthritis is the most common form of arthritis, is a degenerative joint
disease, which mainly affects the articular cartilage. It is associated with
ageing and will most likely affect the joints that have been continually
stressed throughout the years including the knees, hips, fingers, and lower
spine region.
...
(q4003_symptoms_s3, q4004_symptoms_s3, q4005_duration_s3 and q4006_outcome_s3);
and (3) self-reported treatment for arthritis (q4002b_treated_s3). arthritis was
endorsed if the participant answered "yes" (1) to self-reported diagnosis of
arthritis, but not if they affirmed they had never had the disease ("997" to
q4001a_s3).
...
angina (q4014_angina_s3) or if he/she presents several symptoms such as chest
pain when walking downhill, chest pain when walking normally, etc.
(q4016_symptoms_s3, q4017_symptoms_s3, q4018_resp_s3, q4019a_stop_s3,
q4019a_stand_s3, q4020_where_6\_s3,q4020_where_7\_s3, q4020_where_8\_s3,
q4020_where_11_s3). Diagnosis of angina was endorsed if the participant answered
"yes" (1) to self-reported diagnosis, but not if they affirmed they had never
had the disease ("997" to q4014_angina_s3).
...
the participant answered "yes" to self-reported diagnose of diabetes, and not
997 in q4022a_s3 (they do not affirmed they had never had the disease).
...
"yes" to q4025_lungs_s3, and not 997 in q4025a_s3 (they do not affirmed they had
never had the disease). Please, consider that this algorithm does not include
asthma as a part of lung diseases.

## Asthma

A diagnosis of asthma was made if the participant has self-reported having the
disease (q4033_asthma_s3) or if he/she is treated for asthma (q4034c_treated_s3)
or several symptoms such as (1) wheezing attacks (q4035_symptoms_s3), (2)
wheezing attack immediately after physical activity (q4036_symptoms_s3), (3)
feeling of tightness in the chest (q4037_symptoms_s3), (4) woken up with a tight
feeling in chest (q4038_symptoms_s3), (5) attack of shortness of breath, which
occurs without an obvious cause (q4039_symptoms_s3). Those participants who
answered "yes" to all five symptoms were defined as having had asthma. As for
the self-reported diagnosis, asthma was endorsed if the participant answered
"yes" to q4033_asthma_s3, and not 997 in q4033a_s3 (they do not affirmed they
had never had the disease). Note: it is possible to create the symptom algorithm
in a less conservative way. That is: if q4035_symptoms_s3=1 and
q4036_symptoms_s3=1 or q4037_symptoms_s3=1 or q4038_symptoms_s3=1 or
q4039_symptoms_s3=1, asthma_test=1. There is, apparently, no wrong or right
option.
...
hypertension (blood pressure measurement). Hypertension diagnosis was also
assess if participants answer "yes" to the self-reported question about the
condition (q4060_high_bp_s3) and not "997" (they do not affirmed they had never
had the disease).
...
vision (q4064_vision_s3) and (2) visual problems with light (q4065_light_s3). We
also included a treatment code in those individuals who, apart from having
reported a cataract diagnosis, have had surgery for cataracts in the previous 12
months (q4063_surgery_s3).
...
participants who answered "yes" to q4066_teeth_s3, and not 997 in q4066a_s3
(they do not affirmed they had never lost their tooth) were defined as having
had total tooth loss. As for the self-reported symptoms, oral problems were
endorsed if the participant answered "yes" to q4067_symptoms_s3.
...
have also been taken into account (q4086_s3). The answer "Never had this
disease" (997) has been considered has a "No".

## Digestive Disease

A diagnosis of digestive disease was endorsed if the participant self-reported
having a digestive disease (q4087_s3). Treatment taken for digestive disease
have also been taken into account (q4088_s3). The answer "Never had this
disease" (997) has been considered has a "No".

## Cancer

A diagnosis of cancer disease was endorsed if the participant answered "yes" to
self-reported question about cancer (q4089_s3). The answer "Never had this
disease" (997) has been considered has a "No".

## Liver Disease

A diagnosis of liver disease was endorsed if the participant self-reported
having a liver disease (q4091_s3). Treatment taken for liver disease have also
been taken into account (q4092_s3). The answer "Never had this disease" (997)
has been considered has a "No".

## Osteoporosis

A diagnosis of osteoporosis was endorsed if the participant self-reported having
a osteoporosis (q4093_s3). Treatment taken for osteoporosis have also been taken
into account (q4094_s3).

## Anaemia

A diagnosis of anaemia was endorsed if the participant self-reported having a
anaemia (q4095_s3). Treatment taken for anaemia have also been taken into
account (q4096_s3).

## Thyroid

A diagnosis of hyperthyroid or hypothyroid was endorsed if the participant
self-reported having a thyroid condition (q4097_s3). Treatment taken for tyroid
condition have also been taken into account (q4098_s3).

## Glaucoma

A diagnosis of glaucoma was endorsed if the participant self-reported having a
glaucoma (q4099_s3). Treatment taken for glaucoma have also been taken into
account (q4100_s3).

## Heart Disease

A diagnosis of heart disease was endorsed if the participant self-reported
having a heart disease (q4101_s3). Treatment taken for heart disease have also
been taken into account (q4102_s3).
...
been taken into account (q4113c).
...
label define labels0 0 "No" 1 "Yes"
...
replace arthritis_s3=0 if art_test_s3==2 & art_self_s3==2
label values arthritis_s3 labels0
label variable arthritis_s3 "Arthritis test or self-reported (c2011_w4)"
...
replace stroke_s3=0 if stroke_test_s3==2 & str_self_s3==2
label values stroke_s3 labels0
label variable stroke_s3 "Stroke self-reported or test (c2011_w4)"


*ANGINA. 
* Symptoms for angina. 
recode q4016_symptoms_s3 (3=0) (2=0) (888=.) (999=.), gen (q4016_s)
recode q4017_symptoms_s3 (888=.) (999=.) (2=0), gen (q4017_s)
recode q4018_resp_s3 (1=1) (2=1) (3=0) (888=.) (999=.), gen (q4018_r)
recode q4019_stand_s3 (888=.) (999=.) (2=0), gen (q4019_s)
recode q4019a_stop_s3 (3=.) (2=0), gen (q4019a_s)

gen angina_test_s3=0
replace angina_test_s3=1 if (q4016_s==1 | q4017_s==1) & q4018_r==1 & q4019_s==1 & q4019a_s==1 & (q4020_where_6_s3==1 | q4020_where_7_s3==1 | q4020_where_8_s3==1 | q4020_where_11_s3==1)
replace angina_test_s3=. if q4016_s==. & q4017_s==. & q4018_r==. & q4019_s==.
label variable angina_test_s3 "Angina test"

* Angina self-reported. 
recode q4014_angina_s3 (888=.) (999=.) (2=0), gen (ang_1)
replace ang_1=0 if q4014a_s3==997
gen ang_self_s3=.
replace ang_self_s3=1 if ang_1==1
replace ang_self_s3=0 if ang_1==0
...
replace angina_s3=0 if (angina_test_s3==0 & ang_self_s3==0)
label values angina_s3 labels0
label variable angina_s3 "Angina test or self-reported (c2011_w4)"


* DIABETES.
* Diabetes self-reported.
recode q4022_diabetes_s3 (888=.) (999=.) (2=0), gen (diab_self_s3)
replace diab_self_s3=0 if q4022a_s3==997

label variable diab_self_s3 "Diabetes self-reported"
recode q4023b_treated (888=.) (2=0), gen (diab_treatment_s3)
recode q4024_diet_s3 (888=.) (999=.) (2=0), gen (diab_diet_S3)
...
replace diab_s3=2 if diab_self_s3==1 & (diab_treatment_s3==1 | diab_diet_S3==1)
label values diab_s3 labels2
label variable diab_s3 "Diabetes self-reported and treatment (c2011_w4)"
...
replace lung_s3=0 if lung_test_s3==2 & lung_self_s3 ==2
label values lung_s3 labels0
label variable lung_s3 "Lung Disease test or self-reported (c2011_w4)"
...
replace asthma_s3=0 if asthma_test_s3==2 & ast_self_s3==2
label values asthma_s3 labels0
label variable asthma_s3 "Asthma  test or self-reported (c2011_w4)"
...
replace hypertension_s3=0 if hypertension_test_s3==2 & hyper_self_s3 ==2
label values hypertension_s3 labels0
label variable hypertension_s3 "Hypertension test or self-reported (c2011_w4)"
...
recode q4063_surgery_s3 (888=.) (2=0), gen (catar_surgery_s3)
label values catar_surgery_s3 labels1
label variable catar_surgery_s3 "Surgery for cataract"
* Final algorithm for cataracts.
gen cataracts_s3=.
replace cataracts_s3=1 if catar_self_s3==1 | catar_test_s3==1 | catar_surgery_s3==1
replace cataracts_s3=0 if catar_self_s3==2 & catar_test_s3==2
label values cataracts_s3 labels0
label variable cataracts_s3 "Cataract test or self-reported (c2011_w4)"
...
replace oral_s3=0 if oral_self_s3==2 & oral_test_s3==2
label values oral_s3 labels0
label variable oral_s3 "Oral problems test or self-reported (c2011_w4)"


* KIDNEY.
recode q4085_s3 (888=.) (2=0), gen (kidney_self_s3)
replace kidney_self_s3=0 if q4085a_s3==997
...
label variable kidney_s3 "Kidney disease self-reported or treatment (c2011_w4)"


* DIGESTIVE.
recode q4087_s3 (888=.) (2=0), gen (digestive_self_s3)
replace digestive_self_s3=0 if q4087a_s3==997
...
label variable digestive_s3 "Digestive problems self-reported and treatment (c2011_w4)"

* CANCER.
recode q4089_s3 (888=.), gen (cancer_s3)
replace cancer_s3=2 if q4089a_s3==997
recode cancer_s3 (2=0)
label values cancer_s3 labels0
label variable cancer_s3 "Cancer self-reported (c2011_w4)"


* LIVER.
recode q4091_s3 (888=.) (2=0), gen (liver_self_s3)
replace liver_self_s3=0 if q4091a_s3==997
...
label variable liver_s3 "Liver disease self-reported and treatment (c2011_w4)"

* OSTEOPOROSIS.
recode q4093_s3 (888=.) (2=0), gen (osteop_self_s3)
replace osteop_self_s3=0 if q4093a_s3==997
...
label variable osteop_s3 "Osteoporosis self-reported and treatment (c2011_w4)"

* ANAEMIA.
recode q4095_s3 (888=.) (2=0), gen (anaemia_self_s3)
replace anaemia_self_s3=0 if q4095a_s3==997
...
label variable anaemia_s3 "Anaemia self-reported and treatment (c2011_w4)"


* THYROID.
recode q4097_s3 (888=.) (2=0), gen (thyroid_self_s3)
replace thyroid_self_s3=0 if q4097a_s3==997
...
label variable thyroid_s3 "Thyroid self-reported and treatment (c2011_w4)"

* GLAUCOMA.
recode q4099_s3 (888=.) (2=0), gen (glaucoma_self_s3)
replace glaucoma_self_s3=0 if q4099a_s3==997
...
label variable glaucoma_s3 "Glaucoma self-reported and treatment (c2011_w4)"

* HEART CONDITIONS.
recode q4101_s3 (888=.) (2=0), gen (heart_self_s3)
replace heart_self_s3=0 if q4101a_s3==997
label values heart_self_s3 labels1
label variable heart_self_s3 "Heart disease self-reported"
recode q4102c_s3 (888=.) (2=0), gen (heart_treatment_s3)
label values heart_treatment_s3 labels1
label variable heart_treatment_s3 "Treatment for heart conditions"
gen heart_s3=.
replace heart_s3=0 if heart_self_s3==0
replace heart_s3=1 if heart_self_s3==1 
replace heart_s3=2 if heart_self_s3==1 & heart_treatment_s3==1
label values heart_s3 labels2
label variable heart_s3 "Heart conditions self-reported and treatment (c2011_w4)"


* MIGRAINE.
recode q4119_s3 (888=.) (999=.) (2=0), gen (migraine_self_s3)
label values migraine_self_s3 labels1
label variable migraine_self_s3 "Migraine self-reported"
...
label variable migr_s3 "Migraine self-reported and treatment (c2011_w4)"


*CHRONIC BACK PAIN
**Lower back pain
recode q4112_s3 (888=.) (2=0), gen (lowback_self_s3)
replace lowback_self=0 if q4112a_s3==997
recode q4113c_s3 (888=.) (2=0), gen (low_treatment_s3)
label values (lowback_self_s3 low_treatment_s3) labels0
...
label variable lowback_s3 "Lower back pain self-reported and treatment (c2011_w4)"
...
label values (dementia_self_s3 dem_treatment_s3) labels1
 label variable dementia_self_s3 "Dementia self-reported"
...
label variable dem_s3 "Dementia self-reported and treatment (c2011_w4)"
```

```{stata descriptives, cleanlog=FALSE, collectcode=FALSE, results='markup', include=!DOUBLE_CODING}

keep ID_ECS q0007a_result proxy arthritis_s3 stroke_s3 angina_s3 diab_s3 lung_s3 asthma_s3 hypertension_s3 cataracts_s3 oral_s3 kidney_s3 digestive_s3 cancer_s3 liver_s3 osteop_s3 anaemia_s3 thyroid_s3 glaucoma_s3 heart_s3 migr_s3 lowback_s3 dem_s3

codebook arthritis_s3 stroke_s3 angina_s3 diab_s3 lung_s3 asthma_s3 hypertension_s3 cataracts_s3 oral_s3 kidney_s3 digestive_s3 cancer_s3 liver_s3 osteop_s3 anaemia_s3 thyroid_s3 glaucoma_s3 heart_s3 migr_s3 lowback_s3 dem_s3
```
