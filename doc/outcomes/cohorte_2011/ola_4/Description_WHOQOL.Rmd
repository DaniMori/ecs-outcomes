...
A global score in quality of life was obtained by means of WHOQOL-AGE, which is composed by 13 positive items measured on a 1-5 Likert scale. Two factors were identified after conducting an Exploratory Factor Analysis. As a previous step, a Graded Response Model was run and then scores were obtained for each factor based on these models. Finally, the factor scores were transformed into a 0-100 scale and the WHOQOL-AGE global score was obtained as the average in the two factor scores.

# Explanation of how the variables were created

**Quality of Life** was assessed by means of 13 items: `q7001`, `q7002`, `q7003`, `q7004`, `q7005`, `q7006`, `q7007`, `q7008`, `q7009a`, `q7009b`, `q7009c`, `q7009d`, and `q7010b.`.

Details of the validation process were explained in the paper that appears in the References section.

Two factors were obtained, F1 and F2, and the following formula to calculate factor scores was used:

-   `F1=  q7001/2+q7002+(q7003+q7005)/2+q7004+q7006+q7007+q7008`

-   `F2=  q7001/2+(q7009a+q7009b+q7009c)/3+q7009d+q7010b`

Factor scores were transformed into a 0-100 scale and their sum was divided by two in order to obtain the global score in quality of life.
