...
+:===================+:============================================+:============+:===============================+
| alcohol_s3         | Alcohol consumption, categorical (c2011_w4) | Categorical | 0 = Lifetime abstainers;       |
|                    |                                             |             |                                |
...
**q3007_everalc_s3 q3008_last30_s3 q3008b_last7_s3 q3009a_s3 q3009b_s2 q3009c_s2 q3009d_s2 q3009e_s2 q3009f_s2 q3009g_s2**
...
**contamos el número de missing en las variables q3009a-q3009f

egen missq3009= rowmiss(q3009a q3009b q3009c q3009d q3009e q3009f q3009g)


**excluiremos los que tienen missing en 5 o más días
**días de la semana en el que beben 5 o más unidades de alcohol (hombres) y 4 o más unidades (mujeres)
...
**la q3007 (ha bebido alguna vez alcohol) será “no” si en la q3008 nos contestan que “nunca han bebido”
recode q3007 (1=2) if q3008_last30_s3==3
recode q3008_last30_s3 (3=.), gen (q3008)

**Creamos variables separadas para hombres y mujeres y luego las combinamos
**men
gen alcoholm_s3=. 
