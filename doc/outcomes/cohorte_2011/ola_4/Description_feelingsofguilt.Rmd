---
title: "Edad con Salud -- cohort 2011 -- wave 4 -- 'Feelings of guilt (for being a burden)'" ## TODO: Añadir "cohort", "assessment" y "variable name(s)/domain"
output:
  word_document:
...
+:===================+:=========================================+:===========+:=====================+
| burden_guilt_s3    | Feelings of guilt for being a burden     |            | <Categorías / Rango> |
|                    | (c2011_w4)                               |            | <Categorías / Rango> |
+--------------------+------------------------------------------+------------+----------------------+
...
Uno de las principales preocupaciones para adultos mayores relacionadas con la
salud es convertirse en dependientes y ser una carga para los demás. 
El constructo "sentimientos de culpabilidad por ser una carga" (feelings of being
a burden) es un fenómeno muktifacético que incluye

- El sentimiento de culpa por ser resposnsable por las dificultades del cuidador,
- Percepción de transfresoón moral, al creer que se está haciendo daño a otra persona,

La escala original (Self-Perceived Burden Scale; Cousineau et al. 2003) se diseña
para la evaluación de sentimientos de culpa por percibirse a uno mismo como una
carga para la amilia en adultos mayores sin ningún impairment funcional o conitivo. 

Se destacan las siguientes facetas:
Guilt associated with self-perception as a burden
- Culpa asociada a la percepción por ser una carga (no sólo al cuidador, sino a
la familia entera)
-- I feel that I am a burden to my family
--- I feel guilty for overburdening my famility to care for me 

16 items were included in the scale. All the items were answered on a 5-point
Likert scale, from 1 ('never or almost never') to 5 ('almost always'). 

- Self-perceived burden on the family: a single item - 'I feel that I am a burden to
my caregiver' (I feel that I am a burden to my family). 

Scores on the 25-item measure were converted to 0 a 100 scale, with rising scores indicating incresing burden. 
