...
daily arithmetic problems (p1035_other_s3 and p1036_reason_s3). Total score
ranges from 0 to 5 where scores inferior or equal to 1 represent a much better
functioning of cognitive functions; scores between 1 and 2 attest that cognitive
functions are a little bit better; scores between 2 and 3 do not present any
change; score between 3 and 4 attest that cognitive functions are a little bit
worst over time; and, score above 4 represent a much worst functioning of
...
questions (16). The result is a score that ranges from 1 to 5. An average score
of 3 means that the subject is rated as 'no change'. A score of 4 means 'a bit
worse', and a score of 5 is 'much worse'.
