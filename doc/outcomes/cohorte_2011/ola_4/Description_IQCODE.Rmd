...
daily arithmetic problems (p1035_other_s3 and p1036_reason_s3). These items were
assessed on a scale ranging from 1 (much better functioning of cognitive
functions) to 5 (much worst functioning of cognitive functions over time). (2 =
cognitive functions are a little bit better; 3 = any change; and, 4 = little bit
worst).
