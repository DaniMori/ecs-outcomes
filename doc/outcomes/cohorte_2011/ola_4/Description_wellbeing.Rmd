...
+--------------------+------------------------------------------+------------+----------------------+
| flourising_scale_s3| Eudaimonic wellbeing. Flourishing Scale  |Quantitative| 8 (lowest wellbeing)-|
...
- __Evaluative wellbeing__ _(Cantril Self-Anchoring Striving Scale,_ 
@cantril_pattern_1966) (`cantril_present_s3` and `cantril_future_s3`). In words
...
-   **Positive affect** (`positiveaffect_s3`: the average of the two positive 
    emotions (calm/relaxedand enjoying).
...
keep ID_ECS q0007a_result proxy cantril_present_s3  cantril_future_s3  flourising_scale_s3 positiveaffect_s3 negativeaffect_s3  netaffect_s3   
codebook cantril_present_s3  cantril_future_s3  flourising_scale_s3 positiveaffect_s3 negativeaffect_s3  netaffect_s3
```
...
-   Name: Cristina Rodríguez Prada (adapted algorithms for wave 4 & creates originally cantril variables)
-   e-mail:
