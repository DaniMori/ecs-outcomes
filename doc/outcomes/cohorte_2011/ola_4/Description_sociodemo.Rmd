...
|                    |                                          |            | 2 = Female           |
+--------------------+------------------------------------------+------------+----------------------+
| age_s3             | Age, continuous (c2011_w4)               | Continuous | 29-99                |
+--------------------+------------------------------------------+------------+----------------------+
...
|                    |                                          |            | 5 = Widowed          |
+--------------------+------------------------------------------+------------+----------------------+
| highested_s3       | Highest level of education (c2011_w4)    | Categorical| 1 = No formal        |
|                    |                                          |            |     education;       |
|                    |                                          |            |                      |
|                    |                                          |            | 2 = Primary education|
|                    |                                          |            | not completed;       |
...
|                    |                                          |            |     working;         |
+--------------------+------------------------------------------+------------+----------------------+
| occupation_s3      | Working occupation (c2011_w4)            | Ordinal    | 1 = Legislators and  |
|                    |                                          |            | professionals;       |
|                    |                                          |            |                      |
|                    |                                          |            | 2 = Technicians and  |
|                    |                                          |            | clerks;              |
