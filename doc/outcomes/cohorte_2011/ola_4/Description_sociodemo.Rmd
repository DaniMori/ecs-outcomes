...
+:===================+:=========================================+:===========+:=====================+
| sex_s3             | Sex (c2011w4)                            | Categorical| 1 = Male;            |
|                    |                                          |            |                      |
|                    |                                          |            | 2 = Female           |
+--------------------+------------------------------------------+------------+----------------------+
| agegroups_s3       | Age, categorical (c2011_w4)              | Categorical| 1 = 18-29;           |
|                    |                                          |            |                      |
|                    |                                          |            | 2 = 30-49;           |
|                    |                                          |            |                      |
|                    |                                          |            | 3 = 50-64;           |
...
|                    |                                          |            | 5 = 80+              |
+--------------------+------------------------------------------+------------+----------------------+
| marital_s3         | Marital status (c2011_w4)                | Categorical| 1 = Never married    |
|                    |                                          |            | and no cohabiting;   |
|                    |                                          |            |                      |
|                    |                                          |            | 2 = Currently married|
|                    |                                          |            | /law-partnered;      |
...
|                    |                                          |            | 5 = Widowed          |
+--------------------+------------------------------------------+------------+----------------------+
| education_s3       |Level of education, categorical (c2011_w4)| Categorical| 1 = Less than primary|
|                    |                                          |            |;                     |
|                    |                                          |            |                      |
|                    |                                          |            | 2 = Primary;         |
|                    |                                          |            |                      |
...
|                    |                                          |            | 5 = Tertiary         |
+--------------------+------------------------------------------+------------+----------------------+
| employment_s3      | Employment status (c2011_w4)             | Categorical| 1 = Never worked/    |
|                    |                                          |            | homemaker;           |
|                    |                                          |            |                      |
|                    |                                          |            | 2 = Working;         |
|                    |                                          |            |                      |
...
|                    |                                          |            |     working;         |
+--------------------+------------------------------------------+------------+----------------------+
| occupation_s3      | Working occupation (c2011_w4)            | Categorical| 1 = Legislators and  |
|                    |                                          |            | professionals;       |
|                    |                                          |            |                      |
|                    |                                          |            | 2 = Technicians and  |
|                    |                                          |            | clerks;              |
...
- `sex_s3`. Based on `q1009_sex`, we have renamed this variable and established 
properly the missing values. 
...
suiting Sentence case format and missing values were handled properly.
...
`q1504_reason`, four categories are created:
...
elementary occupations and "never worked".
...
recode marital_s3 (888=.)
label define marital 1 "Never married (and no cohabiting)" 2 "Currently married/ law partner" 3 "Cohabiting" 4 "Separated/divorced" 5 "Widowed"
label variable marital_s3 "Marital status (c2011w4)"

*EDUCATION LEVEL - education_s3
recode q1016_highest (0/1 = 1) (5/6 = 5) (888 = .)
...
label variable education_s3 "Level of education, categorical (c2011_w4)"

*EMPLOYMENT STATUS - employment_s3
gen employment_s3 =.

**Never worked
replace employment=1 if q1501_ever_worked==2 | (q1501_ever_worked==1 & (q1504_reason==1 | q1504_reason==6))
**Working 
replace employment=2 if q1503_work_now==1 | (q1503_work_now==2 & (q1504_reason==11 | q1504_reason==13))
**Retired
replace employment=3 if (q1504_reason==5 | q1504_reason==8 | q1504_reason==9) | (q1011_age>65 & q1501_ever_worked!=2 & employment!=2)
**Unemployed
replace employment=4 if (q1504_reason==2 | q1504_reason==3 | q1504_reason==4 | q1504_reason==7 | q1504_reason==10 | q1504_reason==12 | q1504_reason==87) & (q1011_age<66)
