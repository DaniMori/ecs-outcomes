...
| tmt_diff_s3        | Trail making test difference (seconds) (c2011_w4) | Quantitative | 0+   |
...
The time taken to complete each part is recorded. Alont with it, the Trail
...
label variable tmt_ratio_s3    "Trail making test difference (seconds) (c2011_w4)"
```
