...
+:==========================+:===============+:===============+:===============+
| depression_3y_s3          | Depression     | Binary         | 0 no           |
|                           | during the     |                |                |
|                           | last 3 years   |                | 1 yes          |
|                           | (c2011_w4)     |                |                |
+---------------------------+----------------+----------------+----------------+
| depression_3y_proxy_s3    | Depression     | Binary         | 0 no           |
|                           | during the     |                |                |
|                           | last 3 years   |                | 1 yes          |
|                           | for proxy      |                |                |
|                           | (c2011_w4)     |                |                |
...
endorsement of depressive episode at some point in the last three years (from
...
iv) The concurrent presence of at least five of the following symptoms:
    ...
    -   **Cognitive-behavioural cluster:** (3) Reduced ability to concentrate
        ...
        self-worth or excessive and inappropriate guilt (q4222k_s3:q4222l_s3),
        (5) Hopelessness about the future (q4220d_s3), (6) Recurrent thoughts of
            death (q4222r_s3:q4222v_s3);
    -   **Neurovegetative cluster:** (7) Significantly disrupted sleep
        ...
        (q4222f_s3, q4222fa_s3, q4222g_s3, q4222ga_s3), (10) Reduce energy, or
        fatigue (q4222e_s3);
...
v)  At least one symptom from the affective cluster (depressed mood, loss of
    ...
    prevalence of depression during the last three years comparable to other
    waves has been created using the criteria i; iv and above.
...
label variable depression_3y_proxy_s3 "Three years depression for proxy (c2011_w4)"
...
label variable d_12m_item_s3 "12 month depression from three years diagnosis + q4227/q4227a items (c2011_w4)"
...
*#"Three years depression "comparable" (does not take into account exclusion criteria G2 and G3)"
