...
| ression_lifetime | (c2011_w4)       |                  |                  |
|                  |                  |                  | 1 yes            |
+------------------+------------------+------------------+------------------+
| depressio        | Lifetime         | Binary           | 0 no             |
| n_lifetime_proxy | depression for   |                  |                  |
...
keep ID_ECS q0007a_result proxy depression_lifetime depression_lifetime_proxy
