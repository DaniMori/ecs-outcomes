...
Social network is define as "the relatively organized set of relationships that
...
variable ranges from 0 to infinite, with the datum indicating the number of
...
*/NOTE: In the questionnaire items about quality range from 1 to 3 and 999 */correspond to 'Not applicable' but in stata (and it seems to be the good code) */999 correspond to 'close relationship with all membres of this group'.
```
