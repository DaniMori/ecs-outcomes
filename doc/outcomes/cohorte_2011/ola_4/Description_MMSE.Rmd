---
title: "Edad con Salud -- cohort 2011 -- wave 4 -- 'MMSE'" 
output:
  word_document:
...
|:------------------|:------------------------|:------------------|:------------------|
| sum_MMSEc_s3_s3    | Rounded and corrected MMSE total score (c2011_w4) | Discrete | 0-30 |
...
gen sum_MMSEc_s3_s3=round(sum_MMSE_v3)
label variable sum_MMSEc_s3_s3 "Rounded and corrected MMSE total score (c2011_w4)"   
...
keep ID_ECS q0007a_result proxy sum_MMSEc_s3_s3

sum sum_MMSEc_s3_s3, detail
