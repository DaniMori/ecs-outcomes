...
resulting score obtained following the MNA-SF's scoring instructions. The total
score was obtained summing the answer given by the participant to each of the 6
items. The higher the score, the better the participant's nutrition. The six
screening question was the following ones:
...
-   C (q2041_movement_s3, q2046_going_s3): Mobility (rangin from 0 bed or chair
    bound to 2 goes out);
...
-   F (q2507_weight_s3, q2506_height_s3): Body Mass Index (ranging from 0 BMI
    ...
    Note: To created this outcome a merge of two other outcomes is necessary. We
    will use the BMI variable from the data of antropometrics and the variable
    lifetime_depression from depression_ICD10 data.
