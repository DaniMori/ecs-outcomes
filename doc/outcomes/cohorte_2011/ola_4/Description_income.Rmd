...
| hhincomemid_s3     | Annual household income level (bracket's midpoint) (c2011_w4) | Continuous  | 0-1.000.000                          |
| hhquintile_s3      | Quintile of annual household income level (c2011_w4)          | Categorical | 1 higher quintile - 5 lower quintile |
| indincome_s3       | Annual working income level (bracket) (c2011_w4)              | Categorical | 0 - 1.000.000                        |
| indincomemid_s3    | Annual working income level (bracket's midpoint) (c2011_w4)   | Continuous  | 0 - 1.000.000                        |
| indquintile_s3     | Quintile of annual working income level (c2011_w4)            | Categorical | 1 higher quintile - 5 lower quintile |
...
The annual household income level (hhincome_s3 and indincome_s3) was calcultated
...
excluding "Less than 0€", "Don't know" and "Refuse" categories. hhincomemid_s3
and indincome_s3 are created assigning to the categories the midpoint of the
corresponding income bracket (except for the case of "More than 1 million",
which has been categorized as 1 million). The same process has been used to
created the Annual working income level variables. Quintile of annual household
income level and Quintile of annual working income level variables have also
been created using the same items to obtain categorical variables related to
...
label define quantile 1 "Higher quantile" 2 "Fourth quantile" 3 "Third quantile" 4 "Second quantile" 5 "Lower quantile"
...
recode hhincome_s3 (888 = .) (999 = .)
gen hhincomemid_s3 = hhincome_s3
label variable hhincomemid_s3 "Annual household income level (bracket's midpoint) (c2011_w4)"

*# Annual working income level (bracket) (c2011_w4) 

gen indincome_s3 = q1516_total_s3
replace indincome_s3 = q0410k_other_s3 if indincome_s3==1 | indincome_s3==2
replace indincome_s3 = q0410i_ss_s3 if indincome_s3==1 | indincome_s3==2
replace indincome_s3 = q0410j_government_s3 if indincome_s3==1 | indincome_s3==2
label variable indincome_s3 "Annual working income level (bracket) (c2011_w4)"

recode indincome_s3 (888 = .) (999 = .)
gen indincomemid_s3 = indincome_s3
label variable indincomemid_s3 "Annual working income level (bracket's midpoint) (c2011_w4)"

*# Quintile of annual and working income level

recode hhincomemid indincomemid (1=0) (2=500) (3=1500) (4=2500) (5=3500) (6=4500) (7=5500) (8=6500) (9=7500) (10=8500) (11=9500) (12=10500) (13=11500) (14=12500) (15=13500) (16=14500) (17=15500) (18=16500) (19=17500) (20=18500) (21=19500) (22=22500) (23=27500) (24=32500) (25=37500) (26=42500) (27=47500) (28=62500) (29=87500) (30=125000) (31=175500) (32=250000) (33=400000) (34=750000) (35=1000000)
...
label values   hhquintile_s3 quantile
label values   indquintile_s3 quantile

```

```{stata descriptives, cleanlog=FALSE, collectcode=FALSE, results='markup', include=!DOUBLE_CODING}
keep ID_ECS q0007a_result proxy hhincome_s3 indincome_s3 indincomemid_s3 hhincomemid_s3 hhquintile_s3 indquintile_s3

codebook hhincome_s3 indincome_s3 indincomemid_s3 hhincomemid_s3 hhquintile_s3 indquintile_s3
```
