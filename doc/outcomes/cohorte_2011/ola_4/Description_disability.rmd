...
Functioning, Disability, and Health [@internat] and places health and disability
on a continuum, with disability defined as "a decrement in each functioning
domain". Participants were asked to report the level of difficulty they had in
doing various activities during the previous 30 days using a five-point scale
(none=1, mild=2, moderate=3, severe=4, extreme/cannot do=5). The global score
ranges from 0 to 100, with higher scores indicating greater disability. Level of
