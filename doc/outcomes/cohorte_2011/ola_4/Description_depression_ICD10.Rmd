...
| name**            |                 |                 |                 |
+:==================+:================+=================+=================+
| d_                | Severity of     | Ordinal         | -   0=No;       |
| lifetime_severity | lifetime        |                 | -   1=Mild;     |
|                   | depressive      |                 | -   2=Moderate; |
|                   | episode         |                 | -   3=Severe    |
|                   | (c2011_w4)      |                 |                 |
+-------------------+-----------------+-----------------+-----------------+
| de                | Lifetime        | Binary          | -   0=no;       |
| pression_lifetime | depression      |                 | -   1=yes       |
|                   | (c2011_w4)      |                 |                 |
+-------------------+-----------------+-----------------+-----------------+
| depressi          | Lifetime        | Binary          | -   0=no;       |
| on_lifetime_proxy | depression for  |                 | -   1=yes       |
|                   | proxy           |                 |                 |
|                   | (c2011_w4)      |                 |                 |
+-------------------+-----------------+-----------------+-----------------+
...
|                   | (c2011_w4)      |                 |                 |
+-------------------+-----------------+-----------------+-----------------+
| d_li              | Severity of     | Binary          | -   0=no;       |
| fetime_comparable | lifetime        |                 | -   1=yes       |
|                   | depressive      |                 |                 |
|                   | episode         |                 |                 |
|                   | comparable      |                 |                 |
|                   | (c2011_w4)      |                 |                 |
