...
| name**            |                  |                  |                  |
+:==================+:=================+==================+==================+
| d_lif             | Severity of      | Ordinal          | -   0=No;        |
| etime_severity_s3 | lifetime         |                  | -   1=Mild;      |
|                   | depressive       |                  | -   2=Moderate;  |
|                   | episode          |                  | -   3=Severe     |
|                   | (c2011_w4)       |                  |                  |
+-------------------+------------------+------------------+------------------+
| depre             | Lifetime         | Binary           | -   0=no;        |
| ssion_lifetime_s3 | depression       |                  | -   1=yes        |
|                   | (c2011_w4)       |                  |                  |
+-------------------+------------------+------------------+------------------+
| depression_       | Lifetime         | Binary           | -   0=no;        |
| lifetime_proxy_s3 | depression for   |                  | -   1=yes        |
|                   | proxy (c2011_w4) |                  |                  |
+-------------------+------------------+------------------+------------------+
...
|                   | items (c2011_w4) |                  |                  |
+-------------------+------------------+------------------+------------------+
| d_lifet           | Severity of      | Binary           | -   0=no;        |
| ime_comparable_s3 | lifetime         |                  | -   1=yes        |
|                   | depressive       |                  |                  |
|                   | episode          |                  |                  |
|                   | comparable       |                  |                  |
|                   | (c2011_w4)       |                  |                  |
+-------------------+------------------+------------------+------------------+
| d_                | 12 month         | Binary           | -   0=no;        |
| 12m_comparable_s3 | depression       |                  | -   1=yes        |
|                   | comparable with  |                  |                  |
|                   | COVID substudy   |                  |                  |
|                   | (c2011_w4)       |                  |                  |
+-------------------+------------------+------------------+------------------+
