---
title: "Edad con Salud -- cohort 2011 -- wave 4 -- 'anxiety_DSM5'" 
output:
  word_document:
...
| name             |                         |              |              |
+:=================+:========================+:=============+:=============+
| gad_12m_s3       | Generalized anxiety     | Categorical  | 0 no         |
|                  | disorder during last 12 |              |              |
|                  | months (c2011_w4)       |              | 1 yes        |
+------------------+-------------------------+--------------+--------------+
| gad_3y_s3        | Inter-survey            | Categorical  | 0 no         |
|                  | generalized anxiety     |              |              |
|                  | disorder (c2011_w4)     |              | 1 yes        |
+------------------+-------------------------+--------------+--------------+
...
***#"Inter-survey generalized anxiety disorder diagnostic variable":
gen     gad_3y_s3  = .
replace gad_3y_s3  = 0 if gad_crit_2==0 | gad_crit_3==0 | gad_crit_5==0 
replace gad_3y_s3  = 1 if gad_crit_2==1 & gad_crit_3==1 & gad_crit_5==1 
label values   gad_3y_s3  yesno
label variable gad_3y_s3  "Inter-survey generalized anxiety disorder (c2011_w4)"
...
keep ID_ECS q0007a_result proxy gad_3y_s3 gad_12m_s3

codebook gad_3y_s3 gad_12m_s3 
```
