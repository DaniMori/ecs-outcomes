...
gen gad_crit_a = .
replace gad_crit_a = 0 if (q4550_worrylife_s3!=1 & q4550_worrylife_s3!=.) 
replace gad_crit_a = 1 if  q4550_worrylife_s3==1   

*#Criterion B: "Difficulty to control the worry"
gen gad_crit_b = .
replace gad_crit_b = 0 if (q4556_control_s3!=1 & q4556_control_s3!=2 & q4556_control_s3!=.) 
replace gad_crit_b = 1 if  q4556_control_s3==1 | q4556_control_s3==2
...
*#Criterion D: "Worries are related to diffuse concerns"
  gen gad_crit_d = .
replace gad_crit_d = 0 if (q4554_worry1_s3!=1 & q4554_worry1_s3!=.) 
replace gad_crit_d = 1 if  q4554_worry1_s3==1  
...
gen     gad_s3  = .
replace gad_s3  = 0 if gad_crit_a==0 | gad_crit_b==0 | gad_crit_c==0 
replace gad_s3  = 1 if gad_crit_a==1 & gad_crit_b==1 & gad_crit_c==1 
