...
-   **Height** is renamed from `q2506_height_s3` to `height_s3`. It is obtained
    by using a measuring tape. Constraints are set to allow only valid values.

-   **Weight** is renamed from `q2507_weight` to `weight_s3`. It is obtained
    using a weight scale without shoes. Constraints are set to allow only valid
    values.

-   **Waist circumference** is ranamed from `q2508_waist_s3` to `waist_s3`. It
