...
+-----------------+-----------------+-----------------+-------------------+
| **Code**        | **Description** | **Original      | **Dichotomisation |
|                 |                 | categories**    | proposed**        |
+-----------------+-----------------+-----------------+-------------------+
| Overall, in the last 30 days, how much difficulty did you have\...      |
+-----------------+-----------------+-----------------+-------------------+
| **Q2001**       | \...with work   | 1 = None;       | 1 = 1;            |
|                 | or household    |                 |                   |
...
|                 | during the      |                 |                   |
|                 | night or waking | 4 = Severe;     | 4 = 0;            |
|                 | up too early in |                 |                   |
|                 | the morning?    | 5 = Extreme /   | 5 = 0;            |
|                 |                 | Cannot do;      |                   |
+-----------------+-----------------+-----------------+-------------------+
| **Q2017**       | \... have due   |                 |                   |
|                 | to not feeling  |                 |                   |
...
|                 | (from a         |                 |                   |
|                 | distance of     | 4 = Severe;     | 4 = 0;            |
|                 | about 20        |                 |                   |
|                 | meters)?        | 5 = Extreme /   | 5 = 0;            |
|                 |                 | Cannot do;      |                   |
+-----------------+-----------------+-----------------+-------------------+
| **Q2024**       | \... seeing and |                 |                   |
|                 | recognising an  |                 |                   |
...
|                 |                 |                 | percentile = 0;   |
+-----------------+-----------------+-----------------+-------------------+
| **vrecall**     | Inmediate       | Measured test   | Score higher or   |
|                 | verbal recall   |                 | equal than the    |
|                 |                 |                 | 25^th^ percentile |
|                 |                 |                 | = 1;              |
|                 |                 |                 |                   |
|                 |                 |                 | Score lower than  |
