...
|:-------------------|:--------------------------------------------------|:-------------|:------|
| health_s3          | Health status, comparable across waves (c2011_w4) | Quantitative | 0-100 |
...
instead of applying the 25^th^ percentile cut-off point, the previously computed
outcome variable was used, recoding the values so that `0` means "weak" and `1`
...
label var health_s3 "Health status, comparable across waves (c2011_w4)"
```
