...
| name           |                         |                |                |
+:===============+:========================+:===============+:===============+
| grip_max       | Maximum grip strength   | Quantiative    | 0,5 - 99,0     |
|                | [kg] (c2011_w4)         |                |                |
+----------------+-------------------------+----------------+----------------+
...
categories (0 = Normal, 1 = Weak), depending on sex and body mass index
(expressed as ratio). Note: To create this variable it is necessary to combine
the whole raw dataset with the "anthotropometric measures" dataset to be able to
use the previously created variable relating to BMI (bmi_s3).
...
generate grip_s3=1 if (q1009_sex==1 & bmi_s3>0 & bmi_s3<=24 & grip_max<=29)|( q1009_sex==1 & bmi_s3>24 & bmi_s3<=26 & grip_max<=30)| (q1009_sex==1 & bmi_s3>26 & bmi_s3<=28 & grip_max<=30) | (q1009_sex==1 & bmi_s3>28 & bmi_s3<=40 & grip_max<=32)

replace grip_s3=1 if (q1009_sex==2 & bmi_s3>0 & bmi_s3<=23 & grip_max<=17)|( q1009_sex==2 & bmi_s3>23 & bmi_s3<=26 & grip_max<=17.3)| (q1009_sex==2 & bmi_s3>26 & bmi_s3<=29 & grip_max<=18) | (q1009_sex==2 & bmi_s3>29 & bmi_s3<=40 & grip_max<=21)
...
keep ID_ECS q0007a_result proxy grip_max grip_s3

codebook grip_max grip_s3
```
