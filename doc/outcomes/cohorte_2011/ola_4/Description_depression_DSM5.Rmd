...
| name            |                      |                 |                 |
+:================+:=====================+:================+:================+
| depress         | Lifetime depression  | Binary          | 0 no            |
| ion_lifetime_s3 | (c2011_w4)           |                 |                 |
|                 |                      |                 | 1 yes           |
+-----------------+----------------------+-----------------+-----------------+
| de              | 12 months depression | Binary          | 0 no            |
| pression_12m_s3 | (c2011_w4)           |                 |                 |
|                 |                      |                 | 1 yes           |
+-----------------+----------------------+-----------------+-----------------+
| depression      | Treatment for        | Binary          | 0 no            |
| _12treatment_s3 | depression in        |                 |                 |
|                 | previous 12 months   |                 | 1 yes           |
|                 | (c2011_w4)           |                 |                 |
+-----------------+----------------------+-----------------+-----------------+
| dep             | Depression           | Binary          | 0 no            |
| ression_self_s3 | self-reported        |                 |                 |
|                 | (c2011_w4)           |                 | 1 yes           |
+-----------------+----------------------+-----------------+-----------------+
...
hypomanic episode. Those criteria where used to create the variable related to
...
gen     d_A7 = .
replace d_A7 = 0 if q4222n_s3!=1 & q4222n_s3!=. &  q4222l_s3!=1 & q4222l_s3!=. &  q4222m_s3!=1 & q4222m_s3!=. 
replace d_A7 = 1 if q4222n_s3==1 | q4222l_s3==1 | q4222m_s3==1
