...
+:============================+:======================+:============+:============+
| depression_3y_s3            | Three years           | Binary      | 0 No        |
|                             | depression (c2011_w4) |             |             |
|                             |                       |             | 1 Yes       |
+-----------------------------+-----------------------+-------------+-------------+
| depression_12m_s3           | 12 months depression  | Binary      | 0 No        |
|                             | (c2011_w4)            |             |             |
|                             |                       |             | 1 Yes       |
+-----------------------------+-----------------------+-------------+-------------+
...
|                             | (c2011_w4)            |             | 1 Yes       |
+-----------------------------+-----------------------+-------------+-------------+
| d_3y_comparable_s3          | Three years           | Binary      | 0 no        |
|                             | depressive episode    |             |             |
|                             | comparable (c2011_w4) |             | 1 yes       |
+-----------------------------+-----------------------+-------------+-------------+
| d_12m_comparable_s3         | 12 month depression   | Binary      | 0 no        |
|                             | comparable (c2011_w4) |             |             |
|                             |                       |             | 1 yes       |
+-----------------------------+-----------------------+-------------+-------------+
...
episode at some point in their lives (previous three years) and in the previous
...
three years depression (depression_3y_s3). We also created a variable to assess
the presence of a depressive episode during the last 12 months using only one
item (q4227a_s3) which directly asks for the presence of a depressive episode
during this 12-month period.

As the dataset will be used for longitudinal studies, a variable of the
prevalence of depression during the last three years comparable to other waves
has been created using the criteria A, C and D above.
...
label variable depression_3y_s3 "Three years depression (c2011_w4)"
...
*#"Three years depression "comparable" (does not take into account exclusion criteria B and E)"
...
label variable d_3y_comparable_s3 "Three years depressive episode comparable (c2011_w4)"

*#"12-month 'comparable', based on the intermediate 'Three years comparable' and the individual item":
