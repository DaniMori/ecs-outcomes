...
|                              | (c2011_w4)   |              | 1 Yes        |
+------------------------------+--------------+--------------+--------------+
| depression_12treatment_s3    | Treatment    | Dichotomous  | 0 No         |
|                              | for          |              |              |
|                              | depression   |              | 1 Yes        |
|                              | in previous  |              |              |
|                              | 12 months    |              |              |
...
"mourning" for a relative or beloved one as an exclusion criterion for
diagnosing major depressive disorder; this is due to the fact that mourning can
lead to depressive-like symptoms in the short term as a normal response, but can
also be considered pathological when the symptoms are too severe or last for too
long. In this case, we have decided to not consider mourning as an exlusion
criterion in this version of the algorithm. This decision has been agreed upon
with and approved by the Edad con Salud IPs.
...
gen     d_crit_D = .
replace d_crit_D = 0 if                                  q4224b_s3==1                 | (q4224_s3==1 & (q4225_causemed3_s3==1 | q4225_causemed4_s3==1 | q4225_causemed23_s3==1 | q4225_causemed24_s3==1 | q4225_causemed25_s3==1 | q4225_causemed30_s3==1 | q4225_causemed31_s3==1))
