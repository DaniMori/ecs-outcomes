...
replace depression_3y_s3 = 0 if d_skipped==1 | d_crit_A==0 | d_crit_B==0 | d_crit_C==0 | d_crit_D==0 | d_crit_E==0
...
replace d_3y_comparable_s3 = 0 if d_crit_A==0 | d_crit_C==0 | d_crit_D==0 
replace d_3y_comparable_s3 = 1 if d_crit_A==1 & d_crit_C==1 & d_crit_D==1
