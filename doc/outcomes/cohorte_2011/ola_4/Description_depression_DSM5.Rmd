---
title: "Edad con Salud -- 2011 -- Wave 4 -- 'depression_DSM5'"
output:
  word_document:
...
| name           |                       |                |                |
+:===============+:======================+:===============+:===============+
| depressi       | Lifetime depression   | Binary         | 0 no           |
| on_lifetime_s3 | (c2011_w4)            |                |                |
|                |                       |                | 1 yes          |
+----------------+-----------------------+----------------+----------------+
| dep            | 12 months depression  | Binary         | 0 no           |
| ression_12m_s3 | (c2011_w4)            |                |                |
|                |                       |                | 1 yes          |
+----------------+-----------------------+----------------+----------------+
| depression_    | Treatment for         | Binary         | 0 no           |
| 12treatment_s3 | depression in         |                |                |
|                | previous 12 months    |                | 1 yes          |
|                | (c2011_w4)            |                |                |
+----------------+-----------------------+----------------+----------------+
| depr           | Depression            | Binary         | 0 no           |
| ession_self_s3 | self-reported         |                |                |
|                | (c2011_w4)            |                | 1 yes          |
+----------------+-----------------------+----------------+----------------+
...
As for the proxy participants, original variables include a self-diagnosis
depression item (p4040_depression_s3) and self-reported treatment taking
(p4040a_age_s3). A diagnosis of depression was endorsed if the participant
answered "yes" to p4040_depression_s3, but not 997 in p4040a_age_s3 (they
...
one item (q4227a_s3) which directly questions the presence of a depressive
...
gen     d_A2 = .
replace d_A2 = 0 if q4220e_s3!=1 & q4220e_s3!=. & q4220f_s3!=1 & q4220f!=. 
...
gen     d_A7 = .
replace d_A7 = 0 if q4222n_s3!=1 & q4222n_s3!=.
replace d_A7 = 1 if q4222n_s3==1
...
recode q4214_s3 (1=0) (2=1) (3=1) (4=1) (888=0) (999=0)
recode q4215_s3 (1=1) (2=1) (3=0) (4=0) (888=0) (999=0)
recode q4216_s3 (1=0) (2=1) (3=1) (4=0) (888=0) (999=0)

gen     d_crit_B = .
replace d_crit_B = 0 if q4214_s3==0 | q4215_s3==0 | q4216_s3==0
replace d_crit_B = 1 if q4214_s3==1 | q4215_s3==1 | q4216_s3==1

*#"NOTE:In the of previous version item "q4228 has been removed from the questionnaire." 
...
replace depression_lifetime_s3 = 0 if d_skipped==1 | d_crit_A==0 | d_crit_B==0 | d_crit_C==0 & proxy==2
replace depression_lifetime_s3 = 1 if d_skipped==0 & d_crit_A==1 & d_crit_B==1 & d_crit_C==1
label values   depression_lifetime_s3 yesno
label variable depression_lifetime_s3 "Lifetime depression (c2011_w3)"
...
label variable depression_12m_s3 "12 month depression, one item (c2011_w3)"
...
label variable depression_12treatment_s3 "received depression's treatment in the previous 12 months (c2011_w3)"
...
label variable depression_self_s3 "diagnosis of depression"
