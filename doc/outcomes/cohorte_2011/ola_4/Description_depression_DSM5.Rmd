...
As for the proxy participants, original variables include a diagnosis
depression item (p4040_depression_s3) and reported treatment taking
...
The following criteria must be fulfilled in order to diagnose depression: A) At least five of
