...
We have included the cognitive questionnaire from
[@rami_gonzalez_cuestionario_2011], which is composed by the following items:
q1016_highest_s3 (education level), q1052_s3 (training course), q1501a_s3
(languages perfectly spoken), q1053_s3 (musical instrument), q1051_s3
(languages), q1054_s3 (number of books read per year), q1055_s3 (intellectual
games), q1050_s3 (education level of parents). Item q1052 ranges from 0 (none)
to 3 (more than 5), items q1053 from 0 (none) to 2 (good formation), items q1054
from 0 (none) to 4 (more than 10) and item q1055 ranges from 0 (never or
sometimes) to 2 (more than 5 times per month). Transformations were set to allow
only valid values for q1016_highest_s3 (0 "No education" 1 "Basic or primary" 2
"Secondary") and q1050_s3 (0 "Not qualified" 1 "Manual qualification" 2 "Not
manual qualification" 3 "Professional" 4 "Manager"). We have created a composite
score by adding the score obtained for each item, with higher scores indicating
better cognitive reserve. Values range from 0 to 25.
