...
q1055_s3 (intellectual games), q1050_s3 (education level of parents).
Transformations were set to allow only valid values for q1016_highest_s3 and
q1050_s3. We have created a composite score by adding the score obtained for
each item, with higher scores indicating better cognitive reserve. Values range
from 0 to 25.
