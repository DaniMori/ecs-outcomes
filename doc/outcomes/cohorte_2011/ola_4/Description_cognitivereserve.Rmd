...
|:-------------------|:-----------------------------------------|:---------|:-----|
| t_CR               | cognitive reserve total score (c2011_w4) | Discrete | 0-25 |
...
(training course), q1501a_s3 (languages perfectly spoke), q1053_s3 (musical
instrument), q1051_s3 (languages), q1054_s3 (number of books read per year),
q1055_s3 (intellectual games), q1050_s3 (education level of parents). Transformations were set to allow only valid values for
q1016_highest_s3 and q1050_s3. We have created a composite score by
adding the values of the items, with higher scores indicating better cognitive
reserve. Values may range from 0 to 25. Note: we have not included the value 1
in level_edu, because we don´t have this category (Lee y escribe de manera
autodidacta) in our variable q1016_highest_s3. Instead, we have "no formal
education" or "primary studies incompleted."
...
/* cognitive reserve */
egen t_CR =rowtotal(level_edu edu_parent q1051_s3 q1052_s3 occupation q1053_s3 q1054_s3 q1055_s3) if proxy==2
label variable t_CR "cognitive reserve total score (c2011_w4)"
```
