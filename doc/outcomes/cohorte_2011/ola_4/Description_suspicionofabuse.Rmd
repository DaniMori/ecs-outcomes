...
*#   variable is construed by using ifelse statements: '0' and '1' are
*#   recoded as FALSE (in Stata logical values are just 0/1 numeric)" and >1 are
*#   the categories of 2 and 3 of dependency_s3.
*#   The 'if' command allows missings structure to remain intact, otherise they
*#   would become 1, as missing is repesented as an infinite in Stata.
