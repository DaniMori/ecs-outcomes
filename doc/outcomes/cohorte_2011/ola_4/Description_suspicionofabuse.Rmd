...
-   Four ordinal variables, one for **each specific type of abuse**. For each
    specific type of abuse, The first, dichotomous item of the pair is used to
    create the 0 (No abuse) category, and the second item its frequency, if
    abuse is present.
...
To include the **grade of dependency** **in suspicion of abuse**, `abuse_dep_s3`
is created as an intermediate variable. This is a dichotomous variable that
includes:
...
specific to each type of abuse; otherwise, there is no suspicion of abuse (= 0).
