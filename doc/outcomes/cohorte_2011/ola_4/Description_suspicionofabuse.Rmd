...
professional(s). These 4 items ask information about different types of
maltreatment: neglect (`q6702_s3`), psychological (`q6703_s3`), economic
(`q6704_s3`) and physical-sexual (`q6705_s`). The item `q6701_s3` indicates if 
the person has needed help, so in the case of responding 'yes' it could be
some suspicion of abuse. The total scale of suspicion of
abuse was obtain by summing the answer given to each 4 items. A transformation
of the scores was then made, for those participants who answer yes to on of the
five item a suspicion of abuse is consider. The scale ranges from 0: no
suspicion of abuse to 1: suspicion of abuse. The questions refer to situations
that occurred in the 12 months prior to the completion of the questionnaire and
only persons aged 65 and over were asked.
