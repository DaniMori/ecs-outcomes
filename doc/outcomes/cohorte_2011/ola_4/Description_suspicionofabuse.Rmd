...
-   **Abuse within dependency**: "Problematic dependency" or "Neglected dependency"

Suspicion of abuse (`abusesuspicion_s3`) is considered to be present (= 1) if
any of the types of abuse is greater than 0; otherwise, there is no suspicion of
abuse (= 0).
