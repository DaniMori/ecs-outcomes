...
+:==========================+:==============+===============+===============+
| d_3y_severity_s2          | Severity of   | Ordinal       | -   0=No;     |
|                           | depressive    |               | -   1=Mild;   |
|                           | episode       |               | -             |
|                           | during last   |               |   2=Moderate; |
|                           | three years   |               | -   3=Severe  |
|                           | (c2011_w3)    |               |               |
+---------------------------+---------------+---------------+---------------+
| depression_3y_s2          | Three years   | Binary        | -   0=no;     |
|                           | depression    |               | -   1=yes     |
|                           | (c2011_w3)    |               |               |
+---------------------------+---------------+---------------+---------------+
| depression_3y_proxy_s2    | Three years   | Binary        | -   0=no;     |
|                           | depression    |               | -   1=yes     |
|                           | for proxy     |               |               |
|                           | (c2011_w3)    |               |               |
+---------------------------+---------------+---------------+---------------+
| d_12m_item_s2             | 12 month      | Binary        | -   0=no;     |
|                           | depression,   |               | -   1=yes     |
|                           | one item      |               |               |
|                           | (c2011_w3)    |               |               |
+---------------------------+---------------+---------------+---------------+
...
label variable d_3y_severity_s2 "Severity of depressive episode during the last three years (c2011_w3)"
*#"NOTE: The criteria are applied incrementally, such that if a case
...
***#"Three years depression diagnostic variable":
...
label variable depression_3y_s2 "Three years depression (c2011_w3)"
...
label variable depression_3y_proxy_s2 "Three years depression for proxy (c2011_w3)"
...
label variable depression_12m_s2 "12 month depression from three years diagnosis + q4227 items (c2011_w3)"
```
