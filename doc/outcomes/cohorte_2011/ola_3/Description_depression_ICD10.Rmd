...
+:=================================================================+:==============================================================+===========================+=======================================+
| d_3y_severity_s2                                                 | Inter-surve severity of depressive episode (c2011_w3)         | Ordinal                   | -   0=No;                             |
|                                                                  |                                                               |                           | -   1=Mild;                           |
|                                                                  |                                                               |                           | -   2=Moderate;                       |
|                                                                  |                                                               |                           | -   3=Severe                          |
+------------------------------------------------------------------+---------------------------------------------------------------+---------------------------+---------------------------------------+
| depression_3y_s2                                                 | Inter-survey depression (c2011_w3)                            | Binary                    | -   0=No;                             |
|                                                                  |                                                               |                           | -   1=Yes                             |
+------------------------------------------------------------------+---------------------------------------------------------------+---------------------------+---------------------------------------+
| depression_3y_proxy_s2                                           | Inter-survey depression for proxy (c2011_w3)                  | Binary                    | -   0=No;                             |
|                                                                  |                                                               |                           | -   1=Yes                             |
+------------------------------------------------------------------+---------------------------------------------------------------+---------------------------+---------------------------------------+
| d_12m_item_s2                                                    | 12 month depression, one item (c2011_w3)                      | Binary                    | -   0=No;                             |
|                                                                  |                                                               |                           | -   1=Yes                             |
+------------------------------------------------------------------+---------------------------------------------------------------+---------------------------+---------------------------------------+
| depression_12m_s2                                                | 12 month depression from inter-survey diagnosis + q4227 items | Binary                    | -   0=No;                             |
|                                                                  | (c2011_w3)                                                    |                           | -   1=Yes                             |
+------------------------------------------------------------------+---------------------------------------------------------------+---------------------------+---------------------------------------+
...
endorsement of depressive episode at some point in their lives (prevalence;
variable `depression_3y`) and in the previous 12 months (point prevalence;
variable `depression_12m`). More precisely, the following criteria must be
fulfilled:
...
prevalence (variable `d_3y_severity`) based upon the number of symptoms the
participant met.
...
***#"VARIABLE `depression_3y`: Depressive episode (F32)"

*#G1 criterion: "The depressive episode should last for at least 2 weeks"
gen     d_crit_g1 = .
replace d_crit_g1 = 0 if (q4211_s2!=1 & q4211!=.) | (q4213_s2!=1 & q4213_s2!=.)
replace d_crit_g1 = 1 if  q4211_s2==1             |  q4213_s2==1
...
gen     d_crit_g3 = .
replace d_crit_g3 = 0 if                                  q4224b_s2==1                 | (q4224_s2==1 & (q4225_causemed12_s2==1 | q4225_causemed23_s2==1 | q4225_causemed24_s2==1 | q4225_causemed25_s2==1 | q4225_causemed30_s2==1 | q4225_causemed31_s2==1))
replace d_crit_g3 = 1 if (q4224a_s2!=1 & q4224a_s2!=.) | (q4224b_s2!=1 & q4224b_s2!=.) | (q4224_s2==1 & (q4225_causemed12_s2!=1 & q4225_causemed23_s2!=1 & q4225_causemed24_s2!=1 & q4225_causemed25_s2!=1 & q4225_causemed30_s2!=1 & q4225_causemed31_s2!=1))
...
gen     d_b1 = .
replace d_b1 = 0 if q4220a_s2!=1 & q4220a_s2!=. & q4220b_s2!=1 & q4220c_s2!=1 & q4220d_s2!=1
replace d_b1 = 1 if q4220a_s2==1                | q4220b_s2==1 | q4220c_s2==1 | q4220d_s2==1
...
gen     d_b2 = .
replace d_b2 = 0 if q4220e_s2!=1 & q4220e_s2!=. & q4220f_s2!=1
replace d_b2 = 1 if q4220e_s2==1                | q4220f_s2==1

*#B3: "Decreased energy or increased fatigability"
gen     d_b3 = .
replace d_b3 = 0 if q4222e_s2!=1 & q4222e_s2!=.
replace d_b3 = 1 if q4222e_s2==1
...
gen     d_c1 = .
replace d_c1 = 0 if q4222k_s2!=1 & q4222k_s2!=. & q4222l_s2!=1 & q4222l_s2!=. & q4222m_s2!=1
replace d_c1 = 1 if q4222k_s2==1                | q4222l_s2==1                | q4222m_s2==1
...
gen     d_c2 = .
replace d_c2 = 0 if q4222n_s2!=1 & q4222n_s2!=.
replace d_c2 = 1 if q4222n_s2==1

*#C3: "Recurrent thoughts of death or suicide, or any suicidal behaviour"
gen     d_c3 = .
replace d_c3 = 0 if q4222r_s2!=1 & q4222r_s2!=. & q4222s_s2!=1 & q4222t_s2!=1 & q4222u_s2!=1 & q4222v_s2!=1
replace d_c3 = 1 if q4222r_s2==1                | q4222s_s2==1 | q4222t_s2==1 | q4222u_s2==1 | q4222v_s2==1
...
gen     d_c4 = .
replace d_c4 = 0 if q4222h_s2!=1 & q4222h_s2!=. & q4222i_s2!=1 & q4222j_s2!=1
replace d_c4 = 1 if q4222h_s2==1                | q4222i_s2==1 | q4222j_s2==1
...
gen     d_c5 = .
replace d_c5 = 0 if q4222f_s2!=1 & q4222f_s2!=. & q4222fa_s2!=1 & q4222g_s2!=1 & q4222ga_s2!=1
replace d_c5 = 1 if q4222f_s2==1                | q4222fa_s2==1 | q4222g_s2==1 | q4222ga_s2==1
...
gen     d_c6 = .
replace d_c6 = 0 if q4222c_s2!=1 & q4222c_s2!=.
replace d_c6 = 1 if q4222c_s2==1                | q4222d_s2==1
...
gen     d_c7 = .
replace d_c7 = 0 if (q4222a_s2!=1 & q4222a_s2!=.) | (q4222b_s2!=1 & q4222b_s2!=.)
replace d_c7 = 1 if  q4222a_s2==1                 &  q4222b_s2==1
...
recode q4220a_s2-q4222v_s2 (1=1) (2=0) (888 999=.)

*#"Filter variables":
gen  f4217     = q4214_s2==1 & q4215_s2==4 & q4216_s2==4 if q4214_s2!=.
egen f4221_sum = rowtotal (q4220a_s2-q4220f_s2), missing
egen f4223_sum = rowtotal (q4220a_s2-q4222v_s2), missing

*#"Variable "skipped" computation":
gen     d_skipped = .
replace d_skipped = q4202_s2!=1                if q4202_s2 !=.
replace d_skipped = q4211_s2!=1 | d_skipped==1 if q4211_s2 !=.
replace d_skipped = q4213_s2!=1 | d_skipped==1 if q4213_s2 !=.
replace d_skipped = q4218_s2!=1 | d_skipped==1 if q4218_s2 !=.
...
replace d_3y_severity_total = 0 if (d_screentotal+d_symtotal)< 4
...
gen     d_3y_severity_s2 = .
replace d_3y_severity_s2 = 0 if d_skipped==1 | d_crit_a==0 | d_crit_b==0      | d_3y_severity_total==0
replace d_3y_severity_s2 = 1 if d_skipped==0 & d_crit_a==1 & d_crit_b==1      & d_3y_severity_total>=1 & d_3y_severity_total!=.
replace d_3y_severity_s2 = 2 if d_skipped==0 & d_crit_a==1 & d_crit_b==1      & d_3y_severity_total>=2 & d_3y_severity_total!=.
replace d_3y_severity_s2 = 3 if d_skipped==0 & d_crit_a==1 & d_screentotal==3 & d_3y_severity_total==3
label values   d_3y_severity_s2 severity
label variable d_3y_severity_s2 "Inter-survey severity of depressive episode (c2011_w3)"
*#"NOTE: The criteria are applied incrementally, such that if a case
...
gen     depression_3y_s2 = .
replace depression_3y_s2 = 0 if d_3y_severity_s2==0
replace depression_3y_s2 = 1 if d_3y_severity_s2>=1 & d_3y_severity_s2 !=.
label values   depression_3y_s2 yesno
label variable depression_3y_s2 "Inter-survey depression (c2011_w3)"


***#"VARIABLE `depression_3y_proxy`: Depressive episode for proxy participants"
recode p4040_depression_s2 (1=1) (2=0) (888=0) (999=0), gen (depression_3y_proxy_s2)
label values   depression_3y_proxy_s2 yesno
label variable depression_3y_proxy_s2 "Inter-survey depression for proxy (c2011_w3)"


***#"VARIABLE `d_12m_item`: 12-month depression criterion from q4227 items"
gen     d_12m_item_s2 = .
replace d_12m_item_s2 = 0 if q4227_s2!=1 & proxy==2
replace d_12m_item_s2 = 1 if q4227_s2==1
label values   d_12m_item_s2 yesno
label variable d_12m_item_s2 "12 month depression, one item (c2011_w3)"


***#"VARIABLE `depression_12m`: 12-month depression (combining `depression_3y` + `d_12m_item`)"
gen     depression_12m_s2 = .
replace depression_12m_s2 = 0 if depression_3y_s2==0 | d_12m_item_s2==0
replace depression_12m_s2 = 1 if depression_3y_s2==1 & d_12m_item_s2==1
label values   depression_12m_s2 yesno
label variable depression_12m_s2 "12 month depression from inter-survey diagnosis + q4227 items (c2011_w3)"
```

<br>

```{stata descriptives, collectcode=FALSE, results='markup'}
codebook d_3y_severity_s2 depression_3y_s2 depression_3y_proxy_s2 d_12m_item_s2 depression_12m_s2
```

```{stata save-data}
keep ID_ECS q0007a_result proxy d_3y_severity_s2 depression_3y_s2 depression_3y_proxy_s2 d_12m_item_s2 depression_12m_s2
