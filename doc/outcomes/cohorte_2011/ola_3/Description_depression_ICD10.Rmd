...
+:==================================+:===============+================+================+
| d_lifetime_severity_s2            | Severity of    | Ordinal        | -   0=No;      |
|                                   | lifetime       |                | -   1=Mild;    |
|                                   | depressive     |                | -              |
|                                   | episode        |                |    2=Moderate; |
|                                   | (c2011_w3)     |                | -   3=Severe   |
...
|                                   | (c2011_w3)     |                |                |
+-----------------------------------+----------------+----------------+----------------+
| depression_lifetime_proxy_s2      | Lifetime       | Binary         | -   0=no;      |
...
gen     d_lifetime_severity_s2 = .
replace d_lifetime_severity_s2 = 0 if d_skipped==1 | d_crit_a==0 | d_crit_b==0      | d_lifetime_severity_total==0
replace d_lifetime_severity_s2 = 1 if d_skipped==0 & d_crit_a==1 & d_crit_b==1      & d_lifetime_severity_total>=1 & d_lifetime_severity_total!=.
replace d_lifetime_severity_s2 = 2 if d_skipped==0 & d_crit_a==1 & d_crit_b==1      & d_lifetime_severity_total>=2 & d_lifetime_severity_total!=.
replace d_lifetime_severity_s2 = 3 if d_skipped==0 & d_crit_a==1 & d_screentotal==3 & d_lifetime_severity_total==3
label values   d_lifetime_severity_s2 severity
label variable d_lifetime_severity_s2 "Severity of lifetime depressive episode (c2011_w3)"
*#"NOTE: The criteria are applied incrementally, such that if a case
...
replace depression_lifetime_s2 = 0 if d_lifetime_severity_s2==0
replace depression_lifetime_s2 = 1 if d_lifetime_severity_s2>=1 & d_lifetime_severity_s2 !=.
...
recode p4040_depression_s2 (1=1) (2=0) (888=0) (999=0), gen (depression_lifetime_proxy_s2)
label values   depression_lifetime_proxy_s2 yesno
label variable depression_lifetime_proxy_s2 "Lifetime depression for proxy (c2011_w3)"
...
replace depression_12m_s2 = 0 if depression_lifetime_s2==0 | d_12m_item_s2==0
replace depression_12m_s2 = 1 if depression_lifetime_s2==1 & d_12m_item_s2==1
label values   depression_12m_s2 yesno
label variable depression_12m_s2 "12 month depression from lifetime diagnosis + q4227 items (c2011_w3)"
```

<br>

```{stata descriptives, collectcode=FALSE, results='markup'}
codebook d_lifetime_severity_s2 depression_lifetime_s2 depression_lifetime_proxy_s2 d_12m_item_s2 depression_12m_s2
```

```{stata save-data}
keep ID_ECS q0007a_result proxy d_lifetime_severity_s2 depression_lifetime_s2 depression_lifetime_proxy_s2 d_12m_item_s2 depression_12m_s2
