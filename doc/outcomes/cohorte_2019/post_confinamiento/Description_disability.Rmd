...
The WHODAS items were selected and their scoring was determined according to the World Health Organization guidelines. A score in this questionnaire were also obtained for the participants who have answered at least to the 80% of the items (at least, 10 out of the 12 items). In those cases with one or two missing values in these twelve items, the score were obtained based on the items completed, replacing the missing values by the mean on the remaining items.
...
gen S11=SF2_11
gen S12=SF2_12
recode S1 S2 S3 S4 S5 S6 S7 S8 S9 S10 S11 S12 (9=.) 
