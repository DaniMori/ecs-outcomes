...
replace d_30d_severity_org = 0 if (d_crit_g1_org==0 | d_crit_b_org==0 | (d_screentotal_org==2 & d_symtotal_org<2) | (d_screentotal_org==3 & d_symtotal_org==0)) & ESTADO_ENTREVISTA==1
replace d_30d_severity_org = 1 if (d_crit_g1_org==1 & ((d_screentotal_org==2 & d_symtotal_org>=2) | (d_screentotal_org==3 & d_symtotal_org>=1))) & ESTADO_ENTREVISTA==1
replace d_30d_severity_org = 2 if (d_crit_g1_org==1 & ((d_screentotal_org==2 & d_symtotal_org>=4) | (d_screentotal_org==3 & d_symtotal_org>=3))) & ESTADO_ENTREVISTA==1
replace d_30d_severity_org = 3 if (d_crit_g1_org==1 & (d_screentotal_org==3 & d_symtotal_org>=5)) & ESTADO_ENTREVISTA==1
...
* Revisión
gen d_30d_severity = .
replace d_30d_severity = 0 if (d_crit_g1==0 | d_crit_b==0 | (d_screentotal==2 & d_symtotal<2) | (d_screentotal==3 & d_symtotal==0)) 
replace d_30d_severity = 1 if (d_crit_g1==1 & ((d_screentotal==2 & d_symtotal>=2) | (d_screentotal==3 & d_symtotal>=1))) 
replace d_30d_severity = 2 if (d_crit_g1==1 & ((d_screentotal==2 & d_symtotal>=4) | (d_screentotal==3 & d_symtotal>=3))) 
replace d_30d_severity = 3 if (d_crit_g1==1 & (d_screentotal==3 & d_symtotal>=5))
