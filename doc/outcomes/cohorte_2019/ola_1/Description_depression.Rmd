...
***Recent depression (previous 12 months)

gen depression_12m = .
replace depression_12m = 0 if depression_lifetime==0 | depression_lifetime==1 & q4227!=1
replace depression_12m = 1 if depression_lifetime==1 & q4227==1
label variable depression_12m "12 month depression (c2019_w1)"
...
***Recent depression symptomatology prevalence
...
codebook depression_lifetime depression_lifetime_proxy depression_12m depression_symptoms12m 

```

```{stata save-data}
keep ID_ECS q0007a_result proxy subsample_pre interview_pre depression_lifetime d_lifetime_severity depression_lifetime_proxy depression_12m depression_symptoms12m d_12m_severity 
