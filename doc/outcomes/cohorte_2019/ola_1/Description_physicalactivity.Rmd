...
```{stata save-data}
keep ID_ECS q0007a_result proxy subsample_pre interview_pre physical

saveold "~\UAM\marta.miret@uam.es - Documentacion Edad con Salud\Edad con salud - Ola 3\Outcomes\Cohorte 2019\Outcome datasets\Outcome_physicalactivity.dta", replace version(13)
```
