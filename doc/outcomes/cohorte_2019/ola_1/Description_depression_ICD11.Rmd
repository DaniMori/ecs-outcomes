...
*#Criterion 4: "At least one of the following two symptoms (affective cluster)
*#             must be present"
...
*#Criterion 5: "Additional symptoms from the following list should be present,
*#             to give a total of at least five"
