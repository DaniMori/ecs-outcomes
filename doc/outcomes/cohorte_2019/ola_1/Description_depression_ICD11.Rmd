...
iv)   The concurrent presence of at least five of the following symptoms:
    ...
    Affective cluster: (1) Depressed mood, (2) Markedly diminished interest or pleasure;
  
  Cognitive-behavioural cluster: (3) Reduced ability to concentrate and sustain attention, (4) Beliefs of low self-worth or excessive and inappropriate guilt, (5) Hopelessness about the future, (6) Reccurent thoughts of death;
  
  Neurovegetative cluster: (7) Significantly disrupted sleep, (8) Significant change in appetite or weight, (9) Psychomotor agitation or retardation, (10) Reduce energy or fatigue;
...
egen d_screentotal = rowtotal (d_s1 d_s2), missing

*#"To fulfil criterion 4 at least one screening symptoms should be present".
gen     d_crit_4 = .
replace d_crit_4 = 0 if d_screentotal<1 
replace d_crit_4 = 1 if d_screentotal==1 | d_screentotal==2
...
egen d_symptot = rowtotal (d_s2 d_s3 d_s4 d_s5 d_s6 d_s7 d_s8 d_s9 d_s10), missing
