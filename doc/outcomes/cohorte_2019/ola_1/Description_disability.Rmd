...
The WHODAS items were selected and their scoring was determined according to the World Health Organization guidelines. A score in this questionnaire will be also obtained for the participants who have answered at least to the 80% of the items (at least, 10 out of the 12 items). In those cases with one or two missing values in these twelve items, the score will be obtained based on the items completed, replacing the missing values by the mean on the remaining items. ADL and IADL items are scored on a 5 category scale, with 1 indicating no and 5 indicating extreme difficulty. If the person has severe or extreme difficulty at least on one item, the overall score will take 1.
