---
title: "Edad con Salud -- cohort 2019 -- Wave 1 -- 'Health status'"
output:
  word_document:
...
```{r save-data}
output <- survey_data %>%
  select(ID_ECS, q0007a_result, proxy)  %>%
  add_column(
...
output %>% write_dta(
  file.path(
    "~/../UAM",
    "marta.miret@uam.es - Documentacion Edad con Salud/Edad con salud - Ola 3",
    "Outcomes/Cohorte 2019/Submuestra_1_preconfinamiento/Outcome datasets",
