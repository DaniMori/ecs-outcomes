...
- All the filters are considered to be *negative* responses; that is, if an
  ...
  it is assumed that the criterion is "not met" (=`0`). (Note though that this
  rule is reverted for the "exclusion criteria", i.e., criteria "G2" and "G3").
...
*#       But if there is a valid response in `q4220a` there must be one
...
*#       the interview skip logic in `q4222t`. But if there is a valid
