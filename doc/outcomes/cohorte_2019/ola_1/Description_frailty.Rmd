...
STATA_PATH <- r"(C:/Program Files (x86)/StataSE-64.exe)"
...
merge 1:1 ID_ECS using "~\UAM\Marta Miret Garcia - Documentacion Edad con Salud\Edad con salud - Ola 3\Outcomes\Cohorte 2019\Outcome datasets\Outcome_BMI.dta", keepusing(bmi) gen(merge_bmi)
...
merge 1:1 ID_ECS using "~\UAM\Marta Miret Garcia - Documentacion Edad con Salud\Edad con salud - Ola 3\Outcomes\Cohorte 2019\Outcome datasets\Outcome_chronicconditions.dta", keepusing(hypertension stroke oral_self lung diab_self angina asthma arthritis catar_self) gen(merge_chronic)
...
merge 1:1 ID_ECS using "~\UAM\Marta Miret Garcia - Documentacion Edad con Salud\Edad con salud - Ola 3\Outcomes\Cohorte 2019\Outcome datasets\Outcome_gripstrength.dta", keepusing(grip) gen(merge_grip)
...
merge 1:1 ID_ECS using "~\UAM\Marta Miret Garcia - Documentacion Edad con Salud\Edad con salud - Ola 3\Outcomes\Cohorte 2019\Outcome datasets\Outcome_physicalactivity.dta", keepusing(physical) gen(merge_physical)
...
```{stata save-data}
keep ID_ECS q0007a_result proxy subsample_pre interview_pre frailty_score frailty_index

saveold "~\UAM\Marta Miret Garcia - Documentacion Edad con Salud\Edad con salud - Ola 3\Outcomes\Cohorte 2019\Outcome datasets\Outcome_frailty.dta", replace version(13)
```
